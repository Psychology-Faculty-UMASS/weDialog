...
! function (e, t) {
    ...
    r(l, [], function () {
        ...
        function a(e, t, n, r) {
            ...
            if ((t ? t.ownerDocument || t : W) !== H && B(t), t = t || H, n = n || [], !e || "string" != typeof e) return n;
        ...
        function y(e, t) {
            var n = 0,
                ...
                s = function (i, s, l, c, u) {
                    ...
                    for (b && (T = s !== H && s, _ = n); null != (d = x[v]); v++) {
                        if (o && d) {
                            for (f = 0; p = e[f++];)
                                if (p(d, s, l)) {
                                    c.push(d);
        ...
        function x() {}
        var w, _, N, E, S, k, T, R, A, B, H, D, L, M, P, O, I, F = "sizzle" + -new Date,
            W = window.document,
            z = {}, V = 0,
            U = 0,
            q = n(),
        ...
        S = a.isXML = function (e) {
            ...
            return r !== H && 9 === r.nodeType && r.documentElement ? (H = r, D = r.documentElement, L = !S(r), z.getElementsByTagName = o(function (e) {
                ...
                e.id = F + 0, e.appendChild(H.createElement("a")).setAttribute("name", F), e.appendChild(H.createElement("i")).setAttribute("name", F), D.appendChild(e);
                ...
                return e.compareDocumentPosition && 1 & e.compareDocumentPosition(H.createElement("div"))
            ...
            })), (z.matchesSelector = e(O = D.matchesSelector || D.mozMatchesSelector || D.webkitMatchesSelector || D.oMatchesSelector || D.msMatchesSelector)) && o(function (e) {
                z.disconnectedMatch = O.call(e, "div"), O.call(e, "[s!='']:x"), P.push("!=", lt)
            }), M = new RegExp(M.join("|")), P = P.length && new RegExp(P.join("|")), I = e(D.contains) || D.compareDocumentPosition ? function (e, t) {
                ...
                if (t)
                    for (; t = t.parentNode;)
                        if (t === e) return !0;
                return !1
            }, G = D.compareDocumentPosition ? function (e, t) {
                if (e === t) return K = !0, 0;
            ...
            if ((e.ownerDocument || e) !== H && B(e), t = t.replace(xt, "='$1']"), z.matchesSelector && L && (!P || !P.test(t)) && !M.test(t)) try {
                var n = O.call(e, t);
                if (n || z.disconnectedMatch || e.document && 11 !== e.document.nodeType) return n
            } catch (r) {}
            return a(t, H, null, [e]).length > 0
        }, a.contains = function (e, t) {
            return (e.ownerDocument || e) !== H && B(e), I(e, t)
        }, a.attr = function (e, t) {
            var n;
            return (e.ownerDocument || e) !== H && B(e), L && (t = t.toLowerCase()), (n = N.attrHandle[t]) ? n(e) : !L || z.attributes ? e.getAttribute(t) : ((n = e.getAttributeNode(t)) || e.getAttribute(t)) && e[t] === !0 ? t : n && n.specified ? n.value : null
        }, a.error = function (e) {
        ...
        function t(n) {
            ...
            function T(e, t, n) {
                var i, o, a, s, l, c, u, d;
                for (n != I && (o = r()), i = A(e, n), o && o.appendChild(i), a = e.parentNode, s = $(e), l = $(t), ++s, c = l - s, u = e.nextSibling; c > 0;) d = u.nextSibling, i = H(u, n), o && o.appendChild(i), u = d, --c;
        ...
        return function (n, i) {
            ...
            n = n || {}, o.schema = i = i || new e, n.fix_self_closing !== !1 && (n.fix_self_closing = !0), r("comment cdata text start end pi doctype".split(" "), function (e) {
                ...
                var a = this,
                    s, l = 0,
                    c, u, d = [],
                    f, p, h, m, g, v, y, b, C, x, w, _, N, E, S, k, T, R, A, B, H, D, L, M, P, O = 0,
                    I = t.decode,
                    F;
                for (D = new RegExp("<(?:(?:!--([\\w\\W]*?)-->)|(?:!\\[CDATA\\[([\\w\\W]*?)\\]\\]>)|(?:!DOCTYPE([\\w\\W]*?)>)|(?:\\?([^\\s\\/<>]+) ?([\\w\\W]*?)[?/]>)|(?:\\/([^>]+)>)|(?:([A-Za-z0-9\\-\\:\\.]+)((?:\\s+[^\"'>]+(?:(?:\"[^\"]*\")|(?:'[^']*')|[^>]*))*|\\/|\\s+)>))", "g"), L = /([\w:\-]+)(?:\s*=\s*(?:(?:\"((?:[^\"])*)\")|(?:\'((?:[^\'])*)\')|([^>\s]+)))?/g, y = i.getShortEndedElements(), H = n.self_closing_elements || i.getSelfClosingElements(), b = i.getBoolAttrs(), x = n.validate, v = n.remove_internals, F = n.fix_self_closing, M = i.getSpecialElements(); s = D.exec(e);) {
                    if (l < s.index && a.text(I(e.substr(l, s.index - l))), c = s[6]) c = c.toLowerCase(), ":" === c.charAt(0) && (c = c.substr(1)), r(c);
                        ...
                        if (c = c.toLowerCase(), ":" === c.charAt(0) && (c = c.substr(1)), C = c in y, F && H[c] && d.length > 0 && d[d.length - 1].name === c && r(c), !x || (w = i.getElementRule(c))) {
                            if (_ = !0, x && (S = w.attributes, k = w.attributePatterns), (E = s[8]) ? (g = -1 !== E.indexOf("data-mce-type"), g && v && (_ = !1), f = [], f.map = {}, E.replace(L, o)) : (f = [], f.map = {}), x && !g) {
                            ...
                            u.lastIndex = l = s.index + s[0].length, (s = u.exec(e)) ? (_ && (h = e.substr(l, s.index - l)), l = s.index + s[0].length) : (h = e.substr(l), l = e.length), _ && (h.length > 0 && a.text(h, !0), a.end(c)), D.lastIndex = l;
                            continue
                        }
        ...
        return function (r, i) {
            ...
            function a(t) {
                var n, r;
                n = t.screenX - S, r = t.screenY - k, L = n * N[2] + A, M = r * N[3] + B, L = 5 > L ? 5 : L, M = 5 > M ? 5 : M, (e.modifierPressed(t) || "IMG" == x.nodeName && 0 !== N[2] * N[3]) && (L = Math.round(M / H), M = Math.round(L * H)), b.setStyles(w, {
                    width: L,
                    height: M
                }), N[2] < 0 && w.clientWidth <= L && b.setStyle(w, "left", T + (A - L)), N[3] < 0 && w.clientHeight <= M && b.setStyle(w, "top", R + (B - M)), D || (i.fire("ObjectResizeStart", {
                    target: x,
                    width: A,
                    height: B
                }), D = !0)
            ...
            function s() {
                ...
                D = !1, e("width", L), e("height", M), b.unbind(P, "mousemove", a), b.unbind(P, "mouseup", s), O != P && (b.unbind(O, "mousemove", a), b.unbind(O, "mouseup", s)), b.remove(w), I && "TABLE" != x.nodeName || l(x), i.fire("ObjectResized", {
                    target: x,
                    width: L,
                    height: M
                }), i.nodeChanged()
            ...
            function l(e, t, n) {
                ...
                r = b.getPos(e, p), T = r.x, R = r.y, f = e.getBoundingClientRect(), l = f.width || f.right - f.left, u = f.height || f.bottom - f.top, x != e && (m(), x = e, L = M = 0), d = i.fire("ObjectSelected", {
                    ...
                    function o(t) {
                        D = !0, S = t.screenX, k = t.screenY, A = x.clientWidth, B = x.clientHeight, H = B / A, N = e, w = x.cloneNode(!0), b.addClass(w, "mce-clonedresizable"), w.contentEditable = !1, w.unSelectabe = !0, b.setStyles(w, {
                            left: T,
                            top: R,
                            margin: 0
            ...
            var b = i.dom,
                C = t.each,
                x, w, _, N, E, S, k, T, R, A, B, H, D, L, M, P = i.getDoc(),
                O = document,
                I = n.ie && n.ie < 11;
            _ = {
                n: [.5, 0, 0, -1],
        ...
        return function (r) {
                ...
                function d(e, r, o) {
                    ...
                    c = m.inline || m.block, d = I.create(c), s(d), W.walk(e, function (e) {
                        ...
                        if (m.inline || m.wrapper) {
                            ...
                            }), e && m.merge_siblings !== !1 && (e = D(B(e), e), e = D(e, B(e, G)))
                        }
                    })
                }
                var h = c(t),
            ...
            function h(e, t, n) {
                ...
                function f(e) {
                    var t, n;
                    e = T(e, p, G), h.split && (t = L(e, G), n = L(e), t != n ? (/^(TR|TD)$/.test(t.nodeName) && t.firstChild && (t = "TD" == t.nodeName ? t.firstChild || t : t.firstChild.firstChild || t), t = k(t, "span", {
                        id: "_start",
                        "data-mce-type": "bookmark"
                    }), n = k(n, "span", {
                        id: "_end",
            ...
            function T(t, n, a) {
                ...
                var p, h, m, g = t.startContainer,
                    ...
                    y = t.endContainer,
                    b = t.endOffset;
                if (1 == g.nodeType && g.hasChildNodes() && (p = g.childNodes.length - 1, g = g.childNodes[v > p ? p : v], 3 == g.nodeType && (v = 0)), 1 == y.nodeType && y.hasChildNodes() && (p = y.childNodes.length - 1, y = y.childNodes[b > p ? p : b - 1], 3 == y.nodeType && (b = y.nodeValue.length)), g = c(g), y = c(y), (H(g.parentNode) || H(g)) && (g = H(g) ? g : g.parentNode, g = g.nextSibling || g, 3 == g.nodeType && (v = 0)), (H(y.parentNode) || H(y)) && (y = H(y) ? y : y.parentNode, y = y.previousSibling || y, 3 == y.nodeType && (b = y.length)), n[0].inline && (t.collapsed && (m = u(g, v, !0), m && (g = m.container, v = m.offset), m = u(y, b), m && (y = m.container, b = m.offset)), h = l(y, b), h.node)) {
            ...
            function P(t) {
                ...
                if (3 == n.nodeType && r >= n.nodeValue.length && (r = q(n), n = n.parentNode, i = !0), 1 == n.nodeType)
                    for (s = n.childNodes, n = s[Math.min(r, s.length - 1)], o = new e(n, I.getParent(n, I.isBlock)), (r > s.length - 1 || i) && o.next(), a = o.current(); a; a = o.next())
                        if (3 == a.nodeType && !S(a)) return l = I.create("a", null, j), a.parentNode.insertBefore(l, a), t.setStart(a, 0), F.setRng(t), I.remove(l), void 0
            }
            var O = {}, I = r.dom,
                F = r.selection,
                W = new t(I),
        ...
        return function (t) {
            function r(r) {
                ...
                function v() {
                    ...
                    /^(OL|UL|LI)$/.test(n) && (P = "LI"), B = P ? h(P) : i.create("BR"), e(!0) && e() ? "LI" == n ? i.insertAfter(B, t()) : i.replace(B, D) : e(!0) ? "LI" == n ? (i.insertAfter(B, t()), B.appendChild(i.doc.createTextNode(" ")), B.appendChild(D)) : D.parentNode.insertBefore(B, D) : e() ? (i.insertAfter(B, t()), d(B)) : (D = t(), N = _.cloneRange(), N.setStartAfter(T), N.setEndAfter(D), H = N.extractContents(), i.insertAfter(H, D), i.insertAfter(B, D)), i.remove(T), p(B), s.add()
                }
                ...
                if (!r.isDefaultPrevented() && (S = _.startContainer, k = _.startOffset, P = (a.force_p_newlines ? "p" : "") || a.forced_root_block, P = P ? P.toUpperCase() : "", R = i.doc.documentMode, A = r.shiftKey, 1 == S.nodeType && S.hasChildNodes() && (O = k > S.childNodes.length - 1, S = S.childNodes[Math.min(k, S.childNodes.length - 1)] || S, k = O && 3 == S.nodeType ? S.nodeValue.length : 0), E = x(S))) {
                    ...
                    if ((P && !A || !P && A) && (S = g(S, k)), T = i.getParent(S, i.isBlock), D = T ? i.getParent(T.parentNode, i.isBlock) : null, L = T ? T.nodeName.toUpperCase() : "", M = D ? D.nodeName.toUpperCase() : "", "LI" != M || r.ctrlKey || (T = D, L = M), "LI" == L) {
        ...
        return function (a) {
            ...
            var O = o.each,
                ...
                $ = i.ie,
                K = i.webkit;
            C(), N(), d(), D(), K && (_(), u(), p(), g(), k(), i.iOS ? (y(), M()) : f()), $ && i.ie < 11 && (h(), b(), x(), w(), R(), A(), B(), H()), i.ie >= 11 && P(), j && (h(), m(), v(), E(), S(), T(), L())
        }
    }), r(nt, [p], function (e) {
        function t() {
            return !1
    ...
    }), r(it, [v, b, C, S, E, A, H, D, L, M, P, O, y, l, et, x, _, tt, g, p, nt, rt], function (e, n, r, i, o, a, s, l, c, u, d, f, p, h, m, g, v, y, b, C, x, w) {
        function _(e, t) {
        ...
        return N.prototype = {
            ...
            init: function () {
                function e(n) {
                    var r = k.get(n),
                        i, o;
                    i = k.urls[n] || t.documentBaseUrl.replace(/\/$/, ""), n = H(n), r && -1 === B(h, n) && (R(k.dependencies(n), function (t) {
                        e(t)
            ...
            setContent: function (e, t) {
                ...
                return t = t || {}, t.format = t.format || "html", t.set = !0, t.content = e, t.no_events || n.fire("BeforeSetContent", t), e = t.content, 0 === e.length || /^\s+$/.test(e) ? (i = n.settings.forced_root_block, i && n.schema.isValidChild(r.nodeName.toLowerCase(), i.toLowerCase()) ? e = P && 11 > P ? "<" + i + "></" + i + ">" : "<" + i + '><br data-mce-bogus="1"></' + i + ">" : P || (e = '<br data-mce-bogus="1">'), r.innerHTML = e, n.fire("SetContent", t)) : ("raw" !== t.format && (e = new o({}, n.schema).serialize(n.parser.parse(e, {
                    isRootContent: !0
                }))), t.content = H(e), n.dom.setHTML(r, t.content), t.no_events || n.fire("SetContent", t)), t.initial || (n.selection.select(r, !0), n.selection.collapse(!0)), t.content
            },
            getContent: function (e) {
                var t = this,
                    n, r = t.getBody();
            ...
            remove: function () {
                ...
                if (!e.removed) {
                    ...
                    var t = e.getDoc();
                    P && t && t.execCommand("SelectAll"), e.save(), E.setStyle(e.id, "display", e.orgDisplay), e.settings.content_editable || (L.unbind(e.getWin()), L.unbind(e.getDoc()));
                    var n = e.getContainer();
                    L.unbind(e.getBody()), L.unbind(n), e.fire("remove"), e.editorManager.remove(e), E.remove(n), e.destroy()
                }
            },
        ...
        return e.extend({
            showPanel: function () {
                ...
                e.panel.moveRel(e.getEl(), n.popoverAlign || ["bc-tl", "bc-tc"])
            },
            hidePanel: function () {
                var e = this;
        ...
        return e.extend({
            recalc: function (e) {
                var t, n, r, i, o, a, s, l, c, u, d, f, p, h, m, g, v = [],
                    y, b, C, x, w, _, N, E, S, k, T, R, A, B, H, D, L, M, P, O, I, F, W, z, V = Math.max,
                    U = Math.min;
                ...
                if (x = {}, x[E] = 0 > d ? i[E] - d + i[B] : i[R] - d + i[B], x[P] = _ + i[W], x[H] = i[R] - d, x[z] = _, x.minW = U(x.minW, i.maxW), x.minH = U(x.minH, i.maxH), x.minW = V(x.minW, i.startMinWidth), x.minH = V(x.minH, i.startMinHeight), !i.autoResize || x.minW == i.minW && x.minH == i.minH) {
            ...
            recalc: function (e) {
                ...
                if (w += g.left + g.right, _ += g.top + g.bottom, l = {}, l.minW = w + (o.w - o.innerW), l.minH = _ + (o.h - o.innerH), l.contentW = l.minW - o.deltaW, l.contentH = l.minH - o.deltaH, l.minW = Math.min(l.minW, o.maxW), l.minH = Math.min(l.minH, o.maxH), l.minW = Math.max(l.minW, o.startMinWidth), l.minH = Math.max(l.minH, o.startMinHeight), !o.autoResize || l.minW == o.minW && l.minH == o.minH) {
                    ...
                    var D = 0,
                        L = t.flexWidths;
                    if (L)
                        for (d = 0; d < L.length; d++) D += L[d];
                    else D = r;
                    var M = A / D;
                    for (d = 0; r > d; d++) N[d] += L ? Math.ceil(L[d] * M) : M;
                    for (h = g.top, f = 0; n > f; f++) {
                        for (p = g.left, s = E[f] + H, d = 0; r > d && (u = i[f * r + d], u); d++) m = u.settings, c = u.layoutRect(), a = N[d], T = R = 0, c.x = p, c.y = h, v = m.alignH || (C ? C[d] || C[0] : null), "center" == v ? c.x = p + a / 2 - c.w / 2 : "right" == v ? c.x = p + a - c.w : "stretch" == v && (c.w = a), v = m.alignV || (x ? x[d] || x[0] : null), "center" == v ? c.y = h + s / 2 - c.h / 2 : "bottom" == v ? c.y = h + s - c.h : "stretch" == v && (c.h = s), u.layoutRect(c), p += a + y, u.recalc && u.recalc();
                        h += s + b
                    }
        ...
        return e.extend({
            ...
            initLayoutRect: function () {
                var e = this,
                    t, n, r;
                n = e.getEl("head").offsetWidth, n = 0 > n ? 0 : n, r = 0, e.items().each(function (t, i) {
    ...
    }), a([l, c, u, d, f, p, h, m, g, v, y, b, C, x, w, _, N, E, S, k, T, R, A, B, H, D, L, M, P, O, I, F, W, z, V, U, q, j, $, K, G, Y, X, J, Q, Z, et, tt, nt, rt, it, ot, at, st, lt, ct, ut, dt, ft, pt, ht, mt, gt, vt, yt, bt, Ct, xt, wt, _t, Nt, Et, St, kt, Tt, Rt, At, Bt, Ht, Dt, Lt, Mt, Pt, Ot, It, Ft, Wt, zt, Vt, Ut, qt, jt, $t, Kt, Gt, Yt, Xt, Jt])
}(this);
...
tinymce.PluginManager.add("autosave", function (e) {
    ...
    function a() {
        c() || (f.setItem(h + "autosave.draft", e.getContent({
            format: "raw",
            no_events: !0
        })), f.setItem(h + "autosave.time", (new Date).getTime()), e.fire("StoreDraft"))
    }

    function r() {
        n() && (e.setContent(f.getItem(h + "autosave.draft"), {
            format: "raw"
        }), e.fire("RestoreDraft"))
    }
    ...
    function c(t) {
        ...
        return t = tinymce.trim("undefined" == typeof t ? e.getBody().innerHTML : t), "" === t || new RegExp("^<" + n + ">((Â |&nbsp;|[ 	]|<br[^>]*>)+?|)</" + n + ">|<br>$", "i").test(t)
    }
    var m, d = e.settings,
...
tinymce.PluginManager.add("contextmenu", function (e) {
    ...
    e.on("contextmenu", function (t) {
        var o;
        if (t.preventDefault(), o = e.settings.contextmenu || "link image inserttable | cell row column deletetable", n) n.show();
        else {
            var i = [];
            tinymce.each(o.split(/[ ,]/), function (n) {
                ...
                "|" == n && (t = {
                    text: n
                }), t && (t.shortcut = "", i.push(t))
            });
            for (var c = 0; c < i.length; c++) "|" == i[c].text && (0 === c || c == i.length - 1) && i.splice(c, 1);
        ...
        e.inline || (l = tinymce.DOM.getPos(e.getContentAreaContainer()), l.x += t.clientX, l.y += t.clientY), n.moveTo(l.x, l.y)
    })
});
...
tinymce.PluginManager.add("fullpage", function (e) {
    ...
    function l() {
        ...
        var l, n, a = i(),
            o = {};
        return o.fontface = e.getParam("fullpage_default_fontface", ""), o.fontsize = e.getParam("fullpage_default_fontsize", ""), l = a.firstChild, 7 == l.type && (o.xml_pi = !0, n = /encoding="([^"]+)"/.exec(l.value), n && (o.docencoding = n[1])), l = a.getAll("#doctype")[0], l && (o.doctype = "<!DOCTYPE" + l.value + ">"), l = a.getAll("title")[0], l && l.firstChild && (o.title = l.firstChild.value), c(a.getAll("meta"), function (e) {
            var t, l = e.attr("name"),
                n = e.attr("http-equiv");
            l ? o[l.toLowerCase()] = e.attr("content") : "Content-Type" == n && (t = /charset\s*=\s*(.*)\s*/gi.exec(e.attr("content")), t && (o.docencoding = t[1]))
        }), l = a.getAll("html")[0], l && (o.langcode = t(l, "lang") || t(l, "xml:lang")), l = a.getAll("link")[0], l && "stylesheet" == l.attr("rel") && (o.stylesheet = l.attr("href")), l = a.getAll("body")[0], l && (o.langdir = t(l, "dir"), o.style = t(l, "style"), o.visited_color = t(l, "vlink"), o.link_color = t(l, "link"), o.active_color = t(l, "alink")), o
    }
    ...
    function n(t) {
        ...
        a = i(), o = a.getAll("head")[0], o || (s = a.getAll("html")[0], o = new g("head", 1), s.firstChild ? s.insert(o, s.firstChild, !0) : s.append(o)), s = a.firstChild, t.xml_pi ? (m = 'version="1.0"', t.docencoding && (m += ' encoding="' + t.docencoding + '"'), 7 != s.type && (s = new g("xml", 7), a.insert(s, a.firstChild, !0)), s.value = m) : s && 7 == s.type && s.remove(), s = a.getAll("#doctype")[0], t.doctype ? (s || (s = new g("#doctype", 10), t.xml_pi ? a.insert(s, a.firstChild) : n(s)), s.value = t.doctype.substring(9, t.doctype.length - 1)) : s && s.remove(), t.docencoding && (s = null, c(a.getAll("meta"), function (e) {
            "Content-Type" == e.attr("http-equiv") && (s = e)
        }), s || (s = new g("meta", 1), s.attr("http-equiv", "Content-Type"), s.shortEnded = !0, n(s)), s.attr("content", "text/html; charset=" + t.docencoding)), s = a.getAll("title")[0], t.title ? s || (s = new g("title", 1), s.append(new g("#text", 3)).value = t.title, n(s)) : s && s.remove(), c("keywords,description,author,copyright,robots".split(","), function (e) {
            var l, i, o = a.getAll("meta"),
                r = t[e];
            for (l = 0; l < o.length; l++)
                if (i = o[l], i.attr("name") == e) return r ? i.attr("content", r) : i.remove(), void 0;
            r && (s = new g("meta", 1), s.attr("name", e), s.attr("content", r), s.shortEnded = !0, n(s))
        }), s = a.getAll("link")[0], s && "stylesheet" == s.attr("rel") ? t.stylesheet ? s.attr("href", t.stylesheet) : s.remove() : t.stylesheet && (s = new g("link", 1), s.attr({
            rel: "stylesheet",
            text: "text/css",
            href: t.stylesheet
        }), s.shortEnded = !0, n(s)), s = a.getAll("body")[0], s && (l(s, "dir", t.langdir), l(s, "style", t.style), l(s, "vlink", t.visited_color), l(s, "link", t.link_color), l(s, "alink", t.active_color), u.setAttribs(e.getBody(), {
            style: t.style,
            dir: t.dir,
            vLink: t.visited_color,
            link: t.link_color,
            aLink: t.active_color
        })), s = a.getAll("html")[0], s && (l(s, "lang", t.langcode), l(s, "xml:lang", t.langcode)), o.firstChild || o.remove(), r = new tinymce.html.Serializer({
            validate: !1,
            indent: !0,
    ...
    function a(t) {
        ...
        var n, a, r, g, m = t.content,
            u = "",
            f = e.dom;
        t.selection || "raw" == t.format && d || t.source_view && e.getParam("fullpage_hide_in_source_view") || (m = m.replace(/<(\/?)BODY/gi, "<$1body"), n = m.indexOf("<body"), -1 != n ? (n = m.indexOf(">", n), d = l(m.substring(0, n + 1)), a = m.indexOf("</body", n), -1 == a && (a = m.length), t.content = m.substring(n + 1, a), s = l(m.substring(a))) : (d = o(), s = "\n</body>\n</html>"), r = i(), c(r.getAll("style"), function (e) {
...
tinymce.PluginManager.add("importcss", function (t) {
    ...
    function n(e, n) {
        function r(t, e) {
            var c = t.href;
            (e || o[c]) && (!n || n(c)) && (i(t.imports, function (t) {
                r(t, !0)
            }), i(t.cssRules || t.rules, function (t) {
                t.styleSheet ? r(t.styleSheet, !0) : t.selectorText && i(t.selectorText.split(","), function (t) {
                    s.push(tinymce.trim(t))
                })
            }))
        }
        var s = [],
            o = {};
        i(t.contentCSS, function (t) {
            o[t] = !0
        });
        try {
            i(e.styleSheets, r)
    ...
    function r(e) {
        ...
        if (r) {
            ...
            return r[1] ? (n = {
                title: e
            }, t.schema.getTextBlockElements()[s] ? n.block = s : t.schema.getBlockElements()[s] ? n.selector = s : n.inline = s) : r[2] && (n = {
                inline: "span",
                title: e.substr(1),
                classes: i
            }), t.settings.importcss_merge_classes !== !1 ? n.classes = i : n.attributes = {
                "class": i
            }, n
        }
    }
    var s = this,
        i = tinymce.each;
    t.settings.style_formats || t.on("renderFormatsMenu", function (o) {
        var c = t.settings,
            l = {}, a = c.importcss_selector_converter || r,
            f = e(c.importcss_selector_filter);
        t.settings.importcss_append || o.control.items().remove();
        var m = c.importcss_groups;
        if (m)
            for (var u = 0; u < m.length; u++) m[u].filter = e(m[u].filter);
        i(n(t.getDoc(), e(c.importcss_file_filter)), function (e) {
            if (-1 === e.indexOf(".mce-") && !l[e] && (!f || f(e))) {
                ...
                if (r) {
                    ...
                    t.formatter.register(i, r);
                    var u = tinymce.extend({}, o.control.settings.itemDefaults, {
                        text: r.title,
                        format: i
                    });
                    n ? n.push(u) : o.control.add(u)
                }
                l[e] = !0
            }
        }), i(m, function (t) {
            o.control.add(t.item)
        }), o.control.renderNew()
    }), s.convertSelectorToFormat = r
});
tinymce.PluginManager.add("insertdatetime", function (e) {
    ...
    var i, a = "Sun Mon Tue Wed Thu Fri Sat Sun".split(" "),
...
tinymce.PluginManager.add("lists", function (e) {
    ...
    e.on("init", function () {
        function t(e) {
            function n(n) {
                var r, i, o;
                i = e[n ? "startContainer" : "endContainer"], o = e[n ? "startOffset" : "endOffset"], 1 == i.nodeType && (r = L.create("span", {
                    "data-mce-type": "bookmark"
                }), i.hasChildNodes() ? (o = Math.min(o, i.childNodes.length - 1), n ? i.insertBefore(r, i.childNodes[o]) : L.insertAfter(r, i.childNodes[o])) : i.appendChild(r), i = r, o = 0), t[n ? "startContainer" : "endContainer"] = i, t[n ? "startOffset" : "endOffset"] = o
            }
            var t = {};
        ...
        function r(e) {
            function n(n) {
                ...
                var r, i, o;
                r = o = e[n ? "startContainer" : "endContainer"], i = e[n ? "startOffset" : "endOffset"], r && (1 == r.nodeType && (i = t(r), r = r.parentNode, L.remove(o)), e[n ? "startContainer" : "endContainer"] = r, e[n ? "startOffset" : "endOffset"] = i)
            }
            n(!0), n();
            var t = L.createRng();
            t.setStart(e.startContainer, e.startOffset), e.endContainer && t.setEnd(e.endContainer, e.endOffset), b.setRng(t)
        }
        ...
        function s(n, t) {
            var r, i, o;
            if (e.settings.forced_root_block && (t = t || e.settings.forced_root_block), i = t ? L.create(t) : L.createFragment(), n)
                for (; r = n.firstChild;) o || "SPAN" == r.nodeName && "bookmark" == r.getAttribute("data-mce-type") || (o = !0), i.appendChild(r);
            return e.settings.forced_root_block ? o || tinymce.Env.ie && !(tinymce.Env.ie > 10) || i.appendChild(L.create("br", {
                "data-mce-bogus": "1"
            })) : i.appendChild(L.create("br")), i
        }

        function c() {
            return tinymce.grep(b.getSelectedBlocks(), function (e) {
                return "LI" == e.nodeName
            })
        }

        function l(e, n, t) {
            var r, i, o = L.select('span[data-mce-type="bookmark"]', e);
            t = t || s(n), r = L.createRng(), r.setStartAfter(n), r.setEndAfter(e), i = r.extractContents(), L.isEmpty(i) || L.insertAfter(i, e), L.insertAfter(t, e), L.isEmpty(n.parentNode) && (tinymce.each(o, function (e) {
                n.parentNode.parentNode.insertBefore(e, n.parentNode)
            }), L.remove(n.parentNode)), L.remove(n)
        }

        function u(e) {
            var n, t;
            if (n = e.nextSibling, n && i(n) && n.nodeName == e.nodeName) {
                for (; t = n.firstChild;) e.appendChild(t);
                L.remove(n)
            }
            if (n = e.previousSibling, n && i(n) && n.nodeName == e.nodeName) {
                for (; t = n.firstChild;) e.insertBefore(t, e.firstChild);
                L.remove(n)
            }
        }
        ...
        function p(e) {
            tinymce.each(tinymce.grep(L.select("ol,ul", e)), function (e) {
                ...
                "LI" == t.nodeName && t.firstChild == e && (n = t.previousSibling, n && "LI" == n.nodeName && (n.appendChild(e), L.isEmpty(t) && L.remove(t))), i(t) && (n = t.previousSibling, n && "LI" == n.nodeName && n.appendChild(e))
            })
        }
        ...
        function m(e) {
            ...
            var t, r = e.parentNode,
                d = r.parentNode;
            if (o(e) && a(e))
                if ("LI" == d.nodeName) L.insertAfter(e, d), n(d), L.remove(r);
                else {
                    if (!i(d)) return d.insertBefore(s(e), r), L.remove(r), void 0;
                    L.remove(r, !0)
                } else if (o(e))
                if ("LI" == d.nodeName) L.insertAfter(e, d), t = L.create("LI"), t.appendChild(r), L.insertAfter(t, e), n(d);
                else {
                    if (!i(d)) return d.insertBefore(s(e), r), L.remove(e), void 0;
                    d.insertBefore(e, r)
                } else if (a(e))
                if ("LI" == d.nodeName) L.insertAfter(e, d);
                else {
                    if (!i(d)) return L.insertAfter(s(e), r), L.remove(e), void 0;
                    L.insertAfter(e, r)
                } else "LI" == d.nodeName ? (r = d, t = s(e, "LI")) : t = i(d) ? s(e, "LI") : s(e), l(r, e, t), p(r.parentNode);
            return !0
        }

        function v(e) {
            var n, t;
            return n = e.previousSibling, n && "UL" == n.nodeName ? (n.appendChild(e), void 0) : n && "LI" == n.nodeName && i(n.lastChild) ? (n.lastChild.appendChild(e), void 0) : (n = e.nextSibling, n && "UL" == n.nodeName ? (n.insertBefore(e, n.firstChild), void 0) : n && "LI" == n.nodeName && i(e.lastChild) ? void 0 : (n = e.previousSibling, n && "LI" == n.nodeName && (t = L.create(e.parentNode.nodeName), n.appendChild(t), t.appendChild(e)), !0))
        }

        function N() {
            var e, n = t(b.getRng(!0));
        ...
        function C(n) {
            function o() {
                function n(e) {
                    var n, t;
                    for (n = a[e ? "startContainer" : "endContainer"], t = a[e ? "startOffset" : "endOffset"], 1 == n.nodeType && (n = n.childNodes[Math.min(t, n.childNodes.length - 1)] || n); n.parentNode != i;) {
                        if (d(n)) return n;
                ...
                for (var t, r = [], i = e.getBody(), o = n(!0), s = n(), c = [], l = o; l && (c.push(l), l != s); l = l.nextSibling);
                return tinymce.each(c, function (e) {
                    if (d(e)) return r.push(e), t = null, void 0;
                    if (L.isBlock(e) || "BR" == e.nodeName) return "BR" == e.nodeName && L.remove(e), t = null, void 0;
                    var n = e.nextSibling;
                    return f(e) && (d(n) || !n && e.parentNode == i) ? (t = null, void 0) : (t || (t = L.create("p"), e.parentNode.insertBefore(t, e), r.push(t)), t.appendChild(e), void 0)
                }), r
            }
            var a = b.getRng(!0),
                s = t(a),
            ...
            tinymce.each(c, function (e) {
                var t, r;
                r = e.previousSibling, r && i(r) && r.nodeName == n ? (t = r, e = L.rename(e, "LI"), r.appendChild(e)) : (t = L.create(n), e.parentNode.insertBefore(t, e), t.appendChild(e), e = L.rename(e, "LI")), u(t)
            }), r(s)
        }
        ...
        function g() {
            ...
            tinymce.each(c(), function (e) {
                var n, t;
                if (L.isEmpty(e)) return m(e), void 0;
                for (n = e; n; n = n.parentNode) i(n) && (t = n);
                l(t, e)
            }), r(e)
        }

        function y(e) {
            var n = L.getParent(b.getStart(), "OL,UL");
            if (n)
                if (n.nodeName == e) g(e);
                else {
                    var i = t(b.getRng(!0));
        ...
        var L = e.dom,
            b = e.selection;
        n.backspaceDelete = function (e) {
            function n(e, n) {
                var t = e.startContainer,
                    r = e.startOffset;
                if (3 == t.nodeType && (n ? r < t.data.length : r > 0)) return t;
                for (var i = new tinymce.dom.TreeWalker(e.startContainer); t = i[n ? "next" : "prev"]();)
                    if (3 == t.nodeType && t.data.length > 0) return t
            }

            function o(e, n) {
                var t, r, o = e.parentNode;
                for (i(n.lastChild) && (r = n.lastChild), t = n.lastChild, t && "BR" == t.nodeName && e.hasChildNodes() && L.remove(t); t = e.firstChild;) n.appendChild(t);
                r && n.appendChild(r), L.remove(e), L.isEmpty(o) && L.remove(o)
            }
            if (b.isCollapsed()) {
                var a = L.getParent(b.getStart(), "LI");
                if (a) {
                    var d = b.getRng(!0),
                        f = L.getParent(n(d, e), "LI");
                    if (f && f != a) {
                        var s = t(d);
                        return e ? o(f, a) : o(a, f), r(s), !0
                    }
                    if (!f && !e && g(a.parentNode.nodeName)) return !0
                }
            }
        ...
        e.keyCode == tinymce.util.VK.BACKSPACE ? n.backspaceDelete() && e.preventDefault() : e.keyCode == tinymce.util.VK.DELETE && n.backspaceDelete(!0) && e.preventDefault()
    })
});
tinymce.PluginManager.add("media", function (e, t) {
    ...
    function n(t) {
        return t.getAttribute("data-mce-object") ? c(e.serializer.serialize(t, {
            selection: !0
        })) : {}
    }
    ...
    function s(e, t, i) {
        function o(e, t) {
            ...
            for (i in t)
                if (a = "" + t[i], e.map[i])
                    for (o = e.length; o--;) r = e[o], r.name == i && (a ? (e.map[i] = a, r.value = a) : (delete e.map[i], e.splice(o, 1)));
                else a && (e.push({
                    name: i,
                    value: a
                }), e.map[i] = a)
        }
        var a, r = new tinymce.html.Writer,
            c = 0;
        return new tinymce.html.SaxParser({
            validate: !1,
            special: "script,noscript",
...
tinymce.PluginManager.add("noneditable", function (e) {
    function t() {
        ...
        function a(n, i) {
            var o, a;
            return "false" === t(n) && m.isBlock(n) ? (f.select(n), void 0) : (a = m.createRng(), "true" === t(n) && (n.firstChild || n.appendChild(e.getDoc().createTextNode("Â ")), n = n.firstChild, i = !0), o = m.create("span", {
                id: g,
                "data-mce-bogus": !0
        ...
        function l(e) {
            var t, n, a, r;
            if (e) t = f.getRng(!0), t.setStartBefore(e), t.setEndBefore(e), n = o(e), n && n.nodeValue.charAt(0) == p && (n = n.deleteData(0, 1)), m.remove(e, !0), f.setRng(t);
            else
                for (a = i(f.getStart());
                    (e = m.get(g)) && e !== r;) a !== e && (n = o(e), n && n.nodeValue.charAt(0) == p && (n = n.deleteData(0, 1)), m.remove(e, !0)), r = e
        }
        ...
        function u(o) {
            ...
            function u(o) {
                ...
                function r() {
                    ...
                    for (r = new tinymce.dom.TreeWalker(s, e.getBody());
                        (i = o ? r.prev() : r.next()) && !l[i.nodeName.toLowerCase()] && !(3 === i.nodeType && tinymce.trim(i.nodeValue).length > 0);)
    ...
    var i, o, a, r = tinymce.dom.TreeWalker,
        l = "contenteditable",
        s = "data-mce-" + l,
        c = tinymce.util.VK;
...
tinymce.PluginManager.add("pagebreak", function (e) {
    var t, n = "mce-pagebreak",
        i = e.getParam("pagebreak_separator", "<!-- pagebreak -->"),
        a = '<img src="' + tinymce.Env.transparentSrc + '" class="' + n + '" data-mce-resize="false" />';
        ...
        return function (o) {
            ...
            function p(t) {
                var n = o.fire("PastePreProcess", {
                    ...
                    i = o.dom;
                if (t = n.content, o.settings.paste_data_images || (t = t.replace(/<img src=\"data:image[^>]+>/g, "")), (o.settings.paste_remove_styles || o.settings.paste_remove_styles_if_webkit !== !1 && e.webkit) && (t = t.replace(/ style=\"[^\"]+\"/g, "")), !n.isDefaultPrevented()) {
...
tinymce.PluginManager.add("preview", function (e) {
    ...
    e.addCommand("mcePreview", function () {
        e.windowManager.open({
            ...
            onPostRender: function () {
                var n, i = this.getEl("body").firstChild.contentWindow.document,
                    a = "";
                ...
                var o = t.body_class || ""; - 1 != o.indexOf("=") && (o = e.getParam("body_class", "", "hash"), o = o[e.id] || ""), n = "<!DOCTYPE html><html><head>" + a + "</head>" + '<body id="' + r + '" class="mce-content-body ' + o + '">' + e.getContent() + "</body>" + "</html>", i.open(), i.write(n), i.close()
            }
        })
    }), e.addButton("preview", {
        title: "Preview",
    ...
    function t(t) {
        function n() {
            ...
            var a = {}, r = tinymce.ui.Factory.create({
                    ...
                    onSubmit: function (t) {
                        var d, o, s, f;
                        return t.preventDefault(), o = r.find("#case").checked(), f = r.find("#words").checked(), s = r.find("#find").value(), s.length ? a.text == s && a.caseState == o && a.wholeWord == f ? 0 === i(c + 1).length ? (n(), void 0) : (l.next(), e(), void 0) : (d = l.find(s, o, f), d || n(), r.statusbar.items().slice(1).disabled(0 === d), e(), a = {
                            text: s,
                            caseState: o,
                            wholeWord: f
                        }, void 0) : (l.done(!1), r.statusbar.items().slice(1).disabled(!0), void 0)
                    },
                    buttons: [{
                        text: "Find",
                        onclick: function () {
        ...
        function a(n) {
            ...
            return r = t.dom.create("span", {
                ...
                "data-mce-bogus": 1
            }), a = t.getBody(), l.done(!1), e(n, a, r, !1, t.schema)
        }
...
! function (e, t) {
    ...
    var c = {}, l = "tinymce/spellcheckerplugin/DomTextMatcher",
        d = "tinymce/spellcheckerplugin/Plugin",
        s = "tinymce/PluginManager",
        u = "tinymce/util/Tools",
        f = "tinymce/ui/Menu",
        h = "tinymce/dom/DOMUtils",
        g = "tinymce/util/JSONRequest",
        p = "tinymce/util/URI";
    r(l, [], function () {
        return function (e, t, n) {
            ...
            function o(e) {
                ...
                if (t = "", (p[e.nodeName] || v[e.nodeName]) && (t += "\n"), e = e.firstChild)
                    do t += o(e); while (e = e.nextSibling);
                return t
            }
            ...
            var s, u = [],
                f, h = 0,
                g, p, m, v;
            if (g = t.ownerDocument, p = n.getBlockElements(), m = n.getWhiteSpaceElements(), v = n.getShortEndedElements(), f = o(t), f && e.global)
                for (; s = e.exec(f);) u.push(r(s));
            return {
                text: f,
                count: h,
                matches: u,
            ...
            function s() {
                ...
                function r(e, n, r) {
                    i.sendRPC({
                        ...
                        method: e,
                        params: {
                            lang: x.spellchecker_language || "en",
                            words: n
                        },
                        success: function (e) {
                            r(e)
    ...
    function t(n) {
        function t(n) {
            ...
            if (d = i.select(":input:enabled,*[tabindex]:not(iframe)"), o(d, function (n, t) {
                ...
                for (c = u + 1; c < d.length; c++)
                    if (a(d[c])) return d[c]
            } else
                for (c = u - 1; c >= 0; c--)
                    if (a(d[c])) return d[c]; return null
        }
        var u, d, a, c;
...
! function (e, t) {
    ...
    function n(e, t) {
        for (var n, o = [], i = 0; i < e.length; ++i) {
            if (n = a[e[i]] || r(e[i]), !n) throw "module definition dependecy not found: " + e[i];
            o.push(n)
        }
        t.apply(null, o)
    }
    ...
    function l(n) {
        for (var o = 0; o < n.length; o++) {
            for (var i = e, r = n[o], l = r.split(/[.\/]/), s = 0; s < l.length - 1; ++s) i[l[s]] === t && (i[l[s]] = {}), i = i[l[s]];
            i[l[l.length - 1]] = a[r]
        }
    }
    var a = {}, s = "tinymce/tableplugin/TableGrid",
    ...
    o(s, [c, d], function (e, t) {
        ...
        return function (i, r) {
            function l() {
                var e = 0;
                k = [], o(["thead", "tbody", "tfoot"], function (t) {
                    var i = _.select("> " + t + " tr", r);
                    o(i, function (i, r) {
                        r += e, o(_.select("> td, > th", i), function (e, o) {
                            var i, l, a, s;
                            if (k[r])
                                for (; k[r][o];) o++;
                            for (a = n(e, "rowspan"), s = n(e, "colspan"), l = r; r + a > l; l++)
                                for (k[l] || (k[l] = []), i = o; o + s > i; i++) k[l][i] = {
                                    part: t,
                                    real: l == r && i == o,
                                    elm: e,
                                    rowspan: a,
            ...
            function d(e) {
                return e && (_.hasClass(e.elm, "mce-item-selected") || e == I)
            }

            function u() {
                var e = [];
                return o(r.rows, function (t) {
                    o(t.cells, function (n) {
                        return _.hasClass(n, "mce-item-selected") || n == I.elm ? (e.push(t), !1) : void 0
                    })
                }), e
            }
            ...
            function m() {
                var e = _.createRng();
                e.setStartAfter(r), e.setEndAfter(r), D.setRng(e), _.remove(r)
            }

            function f(n) {
                var r, l = {};
                return i.settings.table_clone_elements !== !1 && (l = e.makeMap((i.settings.table_clone_elements || "strong em b i span font h1 h2 h3 h4 h5 h6 p div").toUpperCase(), /[ ,]/)), e.walk(n, function (e) {
                    var i;
                    return 3 == e.nodeType ? (o(_.getParents(e.parentNode, null, n).reverse(), function (e) {
                        l[e.nodeName] && (e = a(e, !1), r ? i && i.appendChild(e) : r = i = e, i = e)
                    }), i && (i.innerHTML = t.ie ? "&nbsp;" : '<br data-mce-bogus="1" />'), !1) : void 0
                }, "childNodes"), n = a(n, !1), c(n, "rowSpan", 1), c(n, "colSpan", 1), r ? n.appendChild(r) : t.ie || (n.innerHTML = '<br data-mce-bogus="1" />'), n
            }

            function h() {
                var e = _.createRng(),
                    t;
                return o(_.select("tr", r), function (e) {
                    0 === e.cells.length && _.remove(e)
                }), 0 === _.select("tr", r).length ? (e.setStartBefore(r), e.setEndBefore(r), D.setRng(e), _.remove(r), void 0) : (o(_.select("thead,tbody,tfoot", r), function (e) {
                    0 === e.rows.length && _.remove(e)
                }), l(), t = k[Math.min(k.length - 1, B.y)], t && (D.select(t[Math.min(t.length - 1, B.x)].elm, !0), D.collapse(!0)), void 0)
            }

            function p(e, t, n, o) {
                var i, r, l, a, s;
                for (i = k[t][e].elm.parentNode, l = 1; n >= l; l++)
                    if (i = _.getNext(i, "tr")) {
                        for (r = e; r >= 0; r--)
                            if (s = k[t + l][r].elm, s.parentNode == i) {
                                for (a = 1; o >= a; a++) _.insertAfter(f(s), s);
                                break
                            }
                        if (-1 == r)
                            for (a = 1; o >= a; a++) i.insertBefore(f(i.cells[0]), i.cells[0])
                    }
            }
            ...
            function g() {
                o(k, function (e, t) {
                    o(e, function (e, o) {
                        var i, r, l;
                        if (d(e) && (e = e.elm, i = n(e, "colspan"), r = n(e, "rowspan"), i > 1 || r > 1)) {
                            for (c(e, "rowSpan", 1), c(e, "colSpan", 1), l = 0; i - 1 > l; l++) _.insertAfter(f(e), e);
                            p(o, t, r - 1, i)
                        }
                    })
                })
            ...
            function b(t, n, i) {
                var r, a, u, m, f, p, b, v, y, w, x;
                if (t ? (r = T(t), a = r.x, u = r.y, m = a + (n - 1), f = u + (i - 1)) : (B = M = null, o(k, function (e, t) {
                    o(e, function (e, n) {
                        d(e) && (B || (B = {
                            x: n,
                            y: t
                ...
                }), a = B.x, u = B.y, m = M.x, f = M.y), v = s(a, u), y = s(m, f), v && y && v.part == y.part) {
                    for (g(), l(), v = s(a, u).elm, c(v, "colSpan", m - a + 1), c(v, "rowSpan", f - u + 1), b = u; f >= b; b++)
                        for (p = a; m >= p; p++) k[b] && k[b][p] && (t = k[b][p].elm, t != v && (w = e.grep(t.childNodes), o(w, function (e) {
                            v.appendChild(e)
                        }), w.length && (w = e.grep(v.childNodes), x = 0, o(w, function (e) {
                            "BR" == e.nodeName && _.getAttrib(e, "data-mce-bogus") && x++ < w.length - 1 && v.removeChild(e)
                        })), _.remove(t)));
                    h()
                }
            }
            ...
            function v(e) {
                var t, i, r, l, s, u, m, h, p;
                for (o(k, function (n, i) {
                    return o(n, function (n) {
                        return d(n) && (n = n.elm, s = n.parentNode, u = a(s, !1), t = i, e) ? !1 : void 0
                    }), e ? !t : void 0
                }), l = 0; l < k[0].length; l++)
                    if (k[t][l] && (i = k[t][l].elm, i != r)) {
                        if (e) {
                            if (t > 0 && k[t - 1][l] && (h = k[t - 1][l].elm, p = n(h, "rowSpan"), p > 1)) {
                                c(h, "rowSpan", p + 1);
                                continue
                            }
                        } else if (p = n(i, "rowspan"), p > 1) {
                            c(i, "rowSpan", p + 1);
                            continue
                        }
                        m = f(i), c(m, "colSpan", i.colSpan), u.appendChild(m), r = i
                    }
                u.hasChildNodes() && (e ? s.parentNode.insertBefore(u, s) : _.insertAfter(u, s))
            }
            ...
            function y(e) {
                ...
                o(k, function (n) {
                    return o(n, function (n, o) {
                        return d(n) && (t = o, e) ? !1 : void 0
                    }), e ? !t : void 0
                }), o(k, function (o, r) {
                    var l, a, s;
                    o[t] && (l = o[t].elm, l != i && (s = n(l, "colspan"), a = n(l, "rowspan"), 1 == s ? e ? (l.parentNode.insertBefore(f(l), l), p(t, r, a - 1, s)) : (_.insertAfter(f(l), l), p(t, r, a - 1, s)) : c(l, "colSpan", l.colSpan + 1), i = l))
                })
            }
            ...
            function w() {
                ...
                o(k, function (i) {
                    o(i, function (i, r) {
                        d(i) && -1 === e.inArray(t, r) && (o(k, function (e) {
                            var t = e[r].elm,
                                o;
                            o = n(t, "colSpan"), o > 1 ? c(t, "colSpan", o - 1) : _.remove(t)
                        }), t.push(r))
                    })
                }), h()
            }
            ...
            function x() {
                function e(e) {
                    var t, i, r;
                    t = _.getNext(e, "tr"), o(e.cells, function (e) {
                        var t = n(e, "rowSpan");
                        t > 1 && (c(e, "rowSpan", t - 1), i = T(e), p(i.x, i.y, 1, 1))
                    }), i = T(e.cells[0]), o(k[i.y], function (e) {
                        var t;
                        e = e.elm, e != r && (t = n(e, "rowSpan"), 1 >= t ? _.remove(e) : c(e, "rowSpan", t - 1), r = e)
                    })
                }
                var t;
                t = u(), o(t.reverse(), function (t) {
                    e(t)
                }), h()
            }
            ...
            function R(e, t) {
                ...
                e && (o(k, function (e) {
                    var t;
                    return r = 0, o(e, function (e) {
                        e.real && (r += e.colspan), e.elm.parentNode == i && (t = 1)
                    }), t ? !1 : void 0
                }), t || e.reverse(), o(e, function (e) {
                    var n, o = e.cells.length,
                        l;
                    for (n = 0; o > n; n++) l = e.cells[n], c(l, "colSpan", 1), c(l, "rowSpan", 1);
                    for (n = o; r > n; n++) e.appendChild(f(e.cells[o - 1]));
                    for (n = r; o > n; n++) _.remove(e.cells[n]);
                    t ? i.parentNode.insertBefore(e, i) : _.insertAfter(e, i)
                }), _.removeClass(_.select("td.mce-item-selected,th.mce-item-selected"), "mce-item-selected"))
            }

            function T(e) {
                var t;
                return o(k, function (n, i) {
                    return o(n, function (n, o) {
                        return n.elm == e ? (t = {
                            x: o,
                            y: i
            ...
            function P() {
                var e, t;
                return e = t = 0, o(k, function (n, i) {
                    o(n, function (n, o) {
                        var r, l;
                        d(n) && (n = k[i][o], o > e && (e = o), i > t && (t = i), n.real && (r = n.colspan - 1, l = n.rowspan - 1, r && o + r > e && (e = o + r), l && i + l > t && (t = i + l)))
                    })
                }), {
                    x: e,
                    y: t
            ...
            function A(e) {
                var t, n, o, i, r, l, a, s, c, d;
                if (M = T(e), B && M) {
                    for (t = Math.min(B.x, M.x), n = Math.min(B.y, M.y), o = Math.max(B.x, M.x), i = Math.max(B.y, M.y), r = o, l = i, d = n; l >= d; d++) e = k[d][t], e.real || t - (e.colspan - 1) < t && (t -= e.colspan - 1);
                    for (c = t; r >= c; c++) e = k[n][c], e.real || n - (e.rowspan - 1) < n && (n -= e.rowspan - 1);
                    for (d = n; i >= d; d++)
                        for (c = t; o >= c; c++) e = k[d][c], e.real && (a = e.colspan - 1, s = e.rowspan - 1, a && c + a > r && (r = c + a), s && d + s > l && (l = d + s));
                    for (_.removeClass(_.select("td.mce-item-selected,th.mce-item-selected"), "mce-item-selected"), d = n; l >= d; d++)
                        for (c = t; r >= c; c++) k[d][c] && _.addClass(k[d][c].elm, "mce-item-selected")
                }
            }
            var k, B, M, I, D = i.selection,
                _ = D.dom;
            r = r || _.getParent(D.getStart(), "table"), l(), I = _.getParent(D.getStart(), "th,td"), I && (B = T(I), M = P(), I = s(B.x, B.y)), e.extend(this, {
                deleteTable: m,
                split: g,
                merge: b,
                insertRow: v,
        ...
        return function (n) {
                ...
                function t(t) {
                    function r(e, o) {
                        var i = e ? "previousSibling" : "nextSibling",
                            ...
                            a = r[i];
                        if (a) return g(n, o, a, e), t.preventDefault(), !0;
                        var d = n.dom.getParent(r, "table"),
                            u = r.parentNode,
                    ...
                    function l(e, t, o, i) {
                        var r = n.dom.select(">" + i, t),
                            l = r.indexOf(o);
                        if (e && 0 === l || !e && l === r.length - 1) return a(e, t);
                        if (-1 === l) {
                    ...
                    function s(e, o, i) {
                        var r = d(o, e);
                        return r && g(n, i, r, e), t.preventDefault(), !0
                    }

                    function c(e, o, i, l) {
                        var a = l[i];
                        if (a) return u(a), !0;
                        var s = n.dom.getParent(l, "td,th");
                        if (s) return r(e, s, t);
                        var c = d(o, !e);
                    ...
                    function g(e, t, o, i) {
                        var r = h(n.dom.getParent(t, "td,th")),
                            l = p(o, r),
                            a = o.childNodes[l],
                            s = d(a, i);
                        u(s || a)
            ...
            function s() {
                function e(e, t, n, o) {
                    var i = 3,
                        ...
                        l, a, s;
                    return r && (l = r.parentNode), a = t.startContainer.nodeType == i && 0 === t.startOffset && 0 === t.endOffset && o && ("TR" == n.nodeName || n == l), s = ("TD" == n.nodeName || "TH" == n.nodeName) && !o, a || s
                }
            ...
            t.webkit && (r(), s()), t.gecko && (l(), a())
        }
    }), o(f, [s, h, c], function (e, t, n) {
        return function (o) {
            function i() {
            ...
            function r(t) {
                var n, i, r = t.target;
                if (s && (a || r != s) && ("TD" == r.nodeName || "TH" == r.nodeName)) {
                    i = l.getParent(r, "table"), i == c && (a || (a = new e(o, i), a.setStartCell(s), o.getBody().style.webkitUserSelect = "none"), a.setEndCell(r), d = !0), n = o.selection.getSel();
                    try {
            ...
            return o.on("MouseDown", function (e) {
                2 != e.button && (i(), s = l.getParent(e.target, "td,th"), c = l.getParent(s, "table"))
            }), l.bind(o.getDoc(), "mouseover", r), o.on("remove", function () {
                l.unbind(o.getDoc(), "mouseover", r)
            }), o.on("MouseUp", function () {
                function e(e, o) {
                    var r = new t(e, e);
                    do {
                        if (3 == e.nodeType && 0 !== n.trim(e.nodeValue).length) return o ? i.setStart(e, 0) : i.setEnd(e, e.nodeValue.length), void 0;
                        if ("BR" == e.nodeName) return o ? i.setStartBefore(e) : i.setEndBefore(e), void 0
                    } while (e = o ? r.next() : r.prev())
                }
                var i, r = o.selection,
                    d, u, m, f, h;
                if (s) {
                    if (a && (o.getBody().style.webkitUserSelect = ""), d = l.select("td.mce-item-selected,th.mce-item-selected"), d.length > 0) {
                        i = l.createRng(), m = d[0], h = d[d.length - 1], i.setStartBefore(m), i.setEndAfter(m), e(m, 1), u = new t(m, l.getParent(d[0], "table"));
                        do
                            if ("TD" == m.nodeName || "TH" == m.nodeName) {
                                if (!l.hasClass(m, "mce-item-selected")) break;
                                f = m
                            } while (m = u.next());
                        e(f), r.setRng(i)
                    }
                    o.nodeChanged(), s = a = c = null
                }
            }), o.on("KeyUp", function () {
                i()
            }), {
    ...
    }), o(p, [s, u, f, c, h, d, g], function (e, t, n, o, i, r, l) {
        function a(o) {
            function i(e) {
            ...
            function c() {
                var e = o.dom,
                    t, n, c;
                t = o.dom.getParent(o.selection.getStart(), "table"), c = !1, n = {
                    ...
                    onsubmit: function () {
                        ...
                        o.undoManager.transact(function () {
                            o.dom.setAttribs(t, {
                                ...
                                width: l(n.width),
                                height: l(n.height)
                            }), i = e.select("caption", t)[0], i && !n.caption && e.remove(i), !i && n.caption && (i = e.create("caption"), r.ie || (i.innerHTML = '<br data-mce-bogus="1"/>'), t.insertBefore(i, t.firstChild)), a(t), n.align && o.formatter.apply("align" + n.align, {}, t), o.focus(), o.addVisual()
                        })
                    }
                })
            }
            ...
            function u() {
                var e = o.dom,
                    t, n, r = [];
                r = o.dom.select("td.mce-item-selected,th.mce-item-selected"), t = o.dom.getParent(o.selection.getStart(), "td,th"), !r.length && t && r.push(t), t = t || r[0], n = {
                    width: i(e.getStyle(t, "width") || e.getAttrib(t, "width")),
                    height: i(e.getStyle(t, "height") || e.getAttrib(t, "height")),
                        ...
                        o.undoManager.transact(function () {
                            s(r, function (n) {
                                o.dom.setAttrib(n, "scope", t.scope), o.dom.setStyles(n, {
                                    width: l(t.width),
                                    height: l(t.height)
                                }), t.type && n.nodeName.toLowerCase() != t.type && (n = e.rename(n, t.type)), a(n), t.align && o.formatter.apply("align" + t.align, {}, n)
                            }), o.focus()
                        })
                    }
                })
                ...
                t = o.dom.getParent(o.selection.getStart(), "table"), n = o.dom.getParent(o.selection.getStart(), "td,th"), s(t.rows, function (t) {
                    ...
                    onsubmit: function () {
                        ...
                        o.undoManager.transact(function () {
                            var c = t.type;
                            s(d, function (s) {
                                o.dom.setAttrib(s, "scope", t.scope), o.dom.setStyles(s, {
                                    height: l(t.height)
                                }), c != s.parentNode.nodeName.toLowerCase() && (n = e.getParent(s, "table"), i = s.parentNode, r = e.select(c, n)[0], r || (r = e.create(c), n.firstChild ? n.insertBefore(r, n.firstChild) : n.appendChild(r)), r.appendChild(s), i.hasChildNodes() || e.remove(i)), a(s), t.align && o.formatter.apply("align" + t.align, {}, s)
                            }), o.focus()
                        })
                    }
                })
            ...
            function h(e, t) {
                var n, i, l;
                for (l = "<table><tbody>", n = 0; t > n; n++) {
                    for (l += "<tr>", i = 0; e > i; i++) l += "<td>" + (r.ie ? " " : "<br>") + "</td>";
                    l += "</tr>"
                }
                l += "</tbody></table>", o.insertContent(l)
            }
            ...
            o.addMenuItem("inserttable", {
                ...
                context: "table",
                onhide: function () {
                    o.dom.removeClass(this.menu.items()[0].getEl().getElementsByTagName("a"), "mce-active")
                },
                menu: [{
                    type: "container",
                    html: v(),
                    onmousemove: function (e) {
                        var t = e.target;
                        if ("A" == t.nodeName) {
                            var n = o.dom.getParent(t, "table"),
                                i = t.getAttribute("data-mce-index");
                            if (i != this.lastPos) {
                                i = i.split(","), i[0] = parseInt(i[0], 10), i[1] = parseInt(i[1], 10);
                                for (var r = 0; 10 > r; r++)
                                    for (var l = 0; 10 > l; l++) o.dom.toggleClass(n.rows[r].childNodes[l].firstChild, "mce-active", l <= i[0] && r <= i[1]);
                                n.nextSibling.innerHTML = i[0] + 1 + " x " + (i[1] + 1), this.lastPos = i
                            }
                        }
                    },
                    onclick: function (e) {
                        "A" == e.target.nodeName && this.lastPos && (e.preventDefault(), h(this.lastPos[0] + 1, this.lastPos[1] + 1), this.parent().cancel())
                    }
                }]
            ...
            s("inserttable tableprops deletetable | cell row column".split(" "), function (e) {
                ...
                y = o.windowManager, x.cellSelection = new n(o)
            }), s({
...
tinymce.PluginManager.add("template", function (e) {
    function t() {
        function t(t) {
            ...
            }) : (n = c.content, r(n)), a.find("#description")[0].text(t.control.value().description)
        }
        var a, n, c = [];
    ...
    function r(t, r) {
        ...
        r = l(r, "template_replace_values"), s = m.create("div", null, r), i = m.select(".mceTmpl", s), i && i.length > 0 && (s = m.create("div", null), s.appendChild(i[0].cloneNode(!0))), c(m.select("*", s), function (t) {
            o(t, e.getParam("template_cdate_classes", "cdate").replace(/\s+/g, "|")) && (t.innerHTML = a(e.getParam("template_cdate_format", e.getLang("template.cdate_format")))), o(t, e.getParam("template_mdate_classes", "mdate").replace(/\s+/g, "|")) && (t.innerHTML = a(e.getParam("template_mdate_format", e.getLang("template.mdate_format")))), o(t, e.getParam("template_selected_content_classes", "selcontent").replace(/\s+/g, "|")) && (t.innerHTML = p)
        }), n(s), e.execCommand("mceInsertContent", !1, s.innerHTML), e.addVisual()
    }
    var c = tinymce.each;
    e.addCommand("mceInsertTemplate", r), e.addButton("template", {
        title: "Insert template",
        onclick: t
...
tinymce.PluginManager.add("visualchars", function (e) {
    function t(t) {
        var n, a, r, o, l, s, c = e.getBody(),
            d = e.selection;
        if (i = !i, e.fire("VisualChars", {
            state: i
        }), t && (s = d.getBookmark()), i)
            for (a = [], tinymce.walk(c, function (e) {
                3 == e.nodeType && e.nodeValue && -1 != e.nodeValue.indexOf("Â ") && a.push(e)
                ...
                for (a = e.dom.select("span.mce-nbsp", c), r = a.length - 1; r >= 0; r--) e.dom.remove(a[r], 1);
        d.moveToBookmark(s)
    }
    ...
    function a() {
        function o() {
            if (d && d.moveRel && d.visible() && !d._fixed) {
                ...
                d.fixed(!1).moveRel(n, ["tl-bl", "bl-tl"]).moveBy(i, o)
            }
        }

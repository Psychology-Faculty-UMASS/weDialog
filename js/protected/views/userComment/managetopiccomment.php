...
<div class="admin_login_form_titel" style="width:98%">
    <table width="100%">
        <tr>
            <td>Manage Comment of Topic <?php //echo $model->topic_id;?></td>
            <td></td>
...
<form name="checked_items" method="POST" action="<?php echo Yii::app()->createUrl('UserComment/managetopicscomment'); ?>">

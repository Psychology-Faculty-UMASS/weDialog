                                                                ...
                                                                <td style="width:100%">
                                                                    <div>
                                                                       ...
                                                                       <div style="float:left;width: 60%;">
                                                                            <div class="postareply" id="showtbldetail1_'.$alltopic->id.'_'.$cnt.'" style="color: #999999;font-family: Arial,Helvetica,sans-serif; font-size: 13px;float:left;margin-top:3px;margin-left:27px;width: 20%;" >
                                                                            ...
                                                                            <div style="float:right;width: 60%;">
                                                                                ...
                                                                                <div id="flag_'.$alltopic->id.'" style="cursor: pointer;;float:right;color:#075A99;width: 50%;font-size: 15px;" onclick="showhide('.$alltopic->id.');">Flag</div>

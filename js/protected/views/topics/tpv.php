    ...
    <div class="main_mid">
        ...
        <div class="topic1" id="show_tbl_detail" style="padding: 0 10px;">
            ...
            <div id="view_topics_content">
                ...
                <p class="topic_desc_text" style="font-family: Arial; font-size: 14px; line-height: 16.1px; width:100%; word-wrap: break-word;">
                    <?php if(!empty($TopicModel->topic_description)){ ?>
                         
                         <span style="line-height: 16.1px;">
                         <span style='font-family: Arial; font-size: 14px'><?php echo substr($TopicModel->topic_description,0, 180); ?></span>
                            <?php if(strlen($TopicModel->topic_description) > 180){ ?>
                                <span class='topic_desc_more_dots'>...</span>
                                <span style='display:none; font-family: Arial; font-size: 14px' class='topic_desc_hidden_text'><?php echo substr($TopicModel->topic_description, 180); ?></span>

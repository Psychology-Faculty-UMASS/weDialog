...
?>
<script type="text/javascript">
var currect_section = "<?php echo (isset(Yii::app()->session['dialog_id']) && TopicQuestions::model()->count('dialog_id=:did AND question1<>""', array(':did'=>$dialogID))>=1)?"agree":"alltopics"; ?>";
 ...
 <div style="clear:both"></div>
  <div class="main">
      ...
      <div class="topics">
       ...
       <div class="menu1">
           <?php $agreeMenuDisplay = (isset(Yii::app()->session['dialog_id']) && TopicQuestions::model()->count('dialog_id=:did AND question1<>""', array(':did'=>$dialogID))>=1)?"inline":"none"; ?>
            <a id="agree" style="padding: 0 0 0 3px;vertical-align: top; font-size: small;text-decoration: none;cursor: pointer;color:  #000000; display: <?php echo $agreeMenuDisplay; ?>" >Agree &nbsp;|&nbsp;</a> 
            <a id="popular" style="padding: 0 0 0 3px;vertical-align: top; font-size: small;text-decoration: none;cursor: pointer;color:  <?php echo (isset(Yii::app()->session['dialog_id']) && TopicQuestions::model()->count('dialog_id=:did AND question1<>""', array(':did'=>$dialogID))>=1)?"#c3c3c3":"#000000" ?>;" >Active &nbsp;|&nbsp;</a> 
            <a id="date" style="padding: 0 0 0 3px;vertical-align: top; font-size: small;text-decoration: none;cursor: pointer;color: #c3c3c3;" >New &nbsp;|&nbsp;</a>
            <a id="last_post" style="padding: 0 0 0 3px;vertical-align: top; font-size: small;text-decoration: none;cursor: pointer;color: #c3c3c3;" >Last Post</a>
    ...
    <!-- =======================START:COMMAN TABLE================================================-->
      ...
      ?>
      <div style="width:98%;display: <?php echo (isset(Yii::app()->session['dialog_id']) && TopicQuestions::model()->count('dialog_id=:did AND question1<>""', array(':did'=>$dialogID))>=1)?"none":"block"; ?>;padding-left: 10px; padding-bottom: 20px;" id="show_tbl_detail">
      ...
      <div class="topic1" id="<?php echo $TopicList->id;?>" <?php echo $style; ?>>
        <h2 style="font-family: tahoma;size: auto;text-decoration-color:#3C1B85 ;">
            <a href="<?php echo Yii::app()->createUrl('topics/Viewtopic',array('topic_id'=>$TopicList->id))?>" style="text-decoration: none;color: #3C1B85;font: 16px;">
        ...
        <p class="toptext" style="font-family: tahoma; word-wrap: break-word;">
            <?php if(!empty($TopicList->topic_description)){
                 ...
                 echo substr($TopicList->topic_description,0, 180);
        ...
        <p class="topictext">
        <div style="color: rgb(153, 153, 153);padding-top: 5px; margin-left:20px;" class="datetime">
     ...
     <?php }?>            
      ...
      <div class="topic1" id="<?php echo $TopicListBymytopics->id;?>" <?php echo $style; ?>>
        <h2 style="font: Tahoma;size: auto;text-decoration-color:#3C1B85 ;">
            <a href="<?php echo Yii::app()->createUrl('topics/Viewtopic',array('topic_id'=>$TopicListBymytopics->id))?>" style="text-decoration: none;color: #3C1B85;font: 16px;">
                <img src="<?php echo Yii::app()->baseUrl;?>/images/Square.png"/>
        ...
        <p class="toptext" style="word-wrap: break-word;">
            <?php if(!empty($TopicListBymytopics->topic_description)){
                 //echo $TopicList->topic_description;
                 echo substr($TopicListBymytopics->topic_description,0, 180);
        ...
        <p class="topictext">
        <div style="color: rgb(153, 153, 153); margin-bottom: 6px; margin-left:20px;" class="datetime">
            <img src="<?php echo Yii::app()->baseUrl ?>/images/comment-icon.png" style="position:relative; top:6px;"/>
            <font size="-1">
      ...
      ?>
      <div style="padding-left: 10px;width:98%; vertical-align: top; display:<?=$display ?> ;" id="show_popular_tbl">
        <?php
            $popular_last_id = 0;
      ...
      <div class="topic1" id="<?php echo $TopicListBypopular->id;?>" <?php echo $style; ?>>
        <h2 style="font: Tahoma;size: auto;text-decoration-color:#3C1B85 ;">
            <a href="<?php echo Yii::app()->createUrl('topics/Viewtopic',array('topic_id'=>$TopicListBypopular->id))?>" style="text-decoration: none;color: #3C1B85;font: 16px;">
             <img src="<?php echo Yii::app()->baseUrl;?>/images/Square.png"/>
        ...
        <p class="toptext" style="word-wrap: break-word;">
            <?php if(!empty($TopicListBypopular->topic_description)){
                 //echo $TopicList->topic_description;
                 echo substr($TopicListBypopular->topic_description,0, 180);
      ...
      <div class="topic1" id="<?php echo $TopicListByagree->id;?>" <?php echo $style; ?>>
        <h2 style="font: Tahoma;size: auto;text-decoration-color:#3C1B85 ;">
            <a href="<?php echo Yii::app()->createUrl('topics/Viewtopic',array('topic_id'=>$TopicListByagree->id))?>" style="text-decoration: none;color: #3C1B85;font: 16px;">
             <img src="<?php echo Yii::app()->baseUrl;?>/images/Square.png"/>
        ...
        <p class="toptext" style="word-wrap: break-word;">
            <?php if(!empty($TopicListByagree->topic_description)){
                 //echo $TopicList->topic_description;
                 echo substr($TopicListByagree->topic_description,0, 180);
      ...
      <div class="topic1" id="<?php echo $TopicListBydateModel->id;?>" <?php echo $style; ?>>
        <h2 style="font: Tahoma;size: auto;text-decoration-color:#3C1B85 ;">
            <a href="<?php echo Yii::app()->createUrl('topics/Viewtopic',array('topic_id'=>$TopicListBydateModel->id))?>" style="text-decoration: none;color: #3C1B85;font: 16px;">
            <img src="<?php echo Yii::app()->baseUrl;?>/images/Square.png"/>
        ...
        <p class="toptext">
            <?php if(!empty($TopicListBydateModel->topic_description)){
                 //echo $TopicList->topic_description;
                 echo "<div style='word-wrap: break-word;'>".substr($TopicListBydateModel->topic_description, 0, 180);
      ...
      <div style="padding-left: 10px;width:98%; vertical-align: top;display: none;" id="show_last_post_tbl">
        <?php
            $last_post_last_id = 0;
      ...
      <div class="topic1" id="<?php echo $TopicListBylastpostModel->id;?>" <?php echo $style; ?>>
        <h2 style="font: Tahoma;size: auto;text-decoration-color:#3C1B85 ;">
            <a href="<?php echo Yii::app()->createUrl('topics/Viewtopic',array('topic_id'=>$TopicListBylastpostModel->id))?>" style="text-decoration: none;color: #3C1B85;font: 16px;">
            <img src="<?php echo Yii::app()->baseUrl;?>/images/Square.png"/>
        ...
        <p class="toptext">
            <?php if(!empty($TopicListBylastpostModel->topic_description)){
                 //echo $TopicList->topic_description;
                 echo "<div style='word-wrap: break-word;'>".substr($TopicListBylastpostModel->topic_description, 0, 180);
    ...
    <div class="main_right" style="float:left">
		...
		?>
		<div class="category">
			<div class="category_head">Tags</div>
			<div class="content_2 content">
		    	<ul style="overflow-x: hidden;overflow-y: hidden;">
		        	<li class="top">
		        		<a href="<?php echo Yii::app()->createUrl('topics/TopicsList')?>" <?php echo $allclass;?> >ALL TOPICS</a>
		        	</li>
		        	<?php 

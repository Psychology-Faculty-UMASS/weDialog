...
<div class="main">
    ...
    <div class="main_mid">
        ...
        <div class="topic1" id="show_tbl_detail" style="padding: 0 10px;">
                ...
                <div style="clear: both;"></div>
            <div>
                <div class="topic_desc" style="color:#3C1B85;font-family: Tahoma;font-size: 16px;padding-bottom: 3px; cursor:pointer;" onclick="javascript: topicdetailmore2('<?php echo $TopicModel->id; ?>')"><?php echo $TopicModel->topic_title;?>
                ...
                <p class="topic_desc_text" style="font-family: tahoma; width:100%; word-wrap: break-word;">
                    <?php if(!empty($TopicModel->topic_description)){
                         ...
                         echo "<span style='font-size:14px; font-family:Arial;'>".substr($TopicModel->topic_description,0, 180)."</span>";
                             if(strlen($TopicModel->topic_description) > 180){
                                echo "<span class='topic_desc_more_dots'>...</span>";
                                echo "<span style='display:none; font-size:14px; font-family:Arial;' class='topic_desc_hidden_text'>".substr($TopicModel->topic_description, 180)."</span>";
                 ...
                 <?php if(!empty($TopicModel->topic_description) && strlen($TopicModel->topic_description) <= 180){ echo "<br/>"; } ?>
            </div>
                    ...
                    <tr style="font-family:Verdana;width:30px; margin:0px 0 0 0; ">
                        <td style="float:left;font-family:Verdana;width:99%">
                            ...
                            <?php if($topic_question_count==0){ ?>
                                ...
                                <object style="float: right; margin-top: 1px;" data="people.svg" type="image/svg+xml">
...
function saveReplay(comment_id,main_comment_id,main_id){
    ...
    var comment = $('#replycomment_'+comment_id+'_ifr').contents().find('body').html();

<div class="main_mid1" id="toggle_column" style="width:95%;display: none;margin: 0 15px;">
    <!--<div class="topics">
        ...
        <div style="float:right;">
            ...
            <a href="<?php echo Yii::app()->createUrl('Team/updateteam',array('id'=>$team_model->id))?>" style="text-transform:none;color: #FFFFFF;font-size: 13px; float: right;text-decoration: none;"><img src="<?php echo Yii::app()->baseUrl;?>/images/edit_team.jpg"/></a>
            <?php } ?>       
        </div>
        </div>
    </div>-->

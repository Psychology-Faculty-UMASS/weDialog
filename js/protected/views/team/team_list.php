    ...
    <div class="main_mid new-width-t-r-t">
      <div class="topics">
        <div class="topic_head">
        	<a style="color:white;" href="<?php Yii::app()->createUrl('Team/teamlist');?>">Teams</a>
       ...
       <div style="padding-top: 12px;padding-left: 8px;" class="common" > 
            <a onclick="menu(this.id);" id="members" style="padding: 0 0 0 3px;vertical-align: top; font-size: small;text-decoration: none;cursor: pointer;color:#000000;" >MEMBERS &nbsp;|&nbsp;</a>
            <a onclick="menu(this.id);" id="posts" style="padding: 0 0 0 3px;vertical-align: top; font-size: small;text-decoration: none;cursor: pointer;color:#c3c3c3;" >POSTS &nbsp;|&nbsp;</a>
            <a onclick="menu(this.id);" id="new" style="padding: 0 0 0 3px;vertical-align: top; font-size: small;text-decoration: none;cursor: pointer;color:#c3c3c3;">NEW</a>  
      </div>
            ...
            <div class="topics">
                <div class="topic_head" style="width:95%;">
                    <div style="float: left;">
                        <div style="font-size:15px;color: white;cursor: pointer;" onclick="$('.more_dis').show();$('.edittopic').show();$('.common').hide();"> About Teams</div>
                    </div>
                </div>
            </div>
            <div class="short_dis" >
                <div class="fontweight" style="padding-left: 10px;color: #666666;font:Arial,Helvetica,sans-serif;font-size: 13px;"><?php echo substr($model_cms->description,0, 300);?>.....<br /><div style="font-size:13px;color:#065A95;cursor: pointer;" onclick="$('.more_dis').show();$('.edittopic').show();$('.common').hide();">More</div></div>
            </div>
        <!-- //============================END:  RIGHT PANEL    =======================  -->
    </div>
  </div>    

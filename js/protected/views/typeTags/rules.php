...
<div class="main">
    ...
    <div class="main_mid new-width-t-r-t">
      ...
      <!--==============End:create Rules tag==============================-->
       ...
       <div style="padding-top: 12px;padding-left: 9px;" class="common"  > 
            <a onclick="menu(this.id);" id="agree" style="padding: 0 0 0 3px;vertical-align: top; font-size: small;text-decoration: none;cursor: pointer;color:#000000;" >AGREE &nbsp;|&nbsp;</a>
            ...
            <?php if($this->data['group_id']==1){ ?>
                <a href="<?php echo Yii::app()->createUrl('TypeTags/order');?>" style="float:right;padding: 0 0 0 3px;vertical-align: top; font-size: small;text-decoration: none;cursor: pointer;color:#c3c3c3;">SELECT</a>
            <?php } ?>
      </div>
    ...
    <div class="main_right" style="float: left">
	    ...
	    <div class="category" id="toggle_column">
	        ...
	        <div class="short_dis" >
	            <div class="fontweight" style="padding-left: 10px;color: #666666;font:Arial,Helvetica,sans-serif;font-size: 13px;">
	                <?php echo substr($model_cms->description,0, 300);?>.....<br />
	                <div style="font-size:13px;cursor: pointer;color: #065A95;" onclick="$('.more_dis').show();$('.edittopic').show();$('.common').hide();">
	                More
	                </div>
	            </div>
	        </div>

...
<div class="category" id="rightboxtoggle5" style="border-bottom:none;padding-bottom:0px;">
    <div class="categoryr_head" onclick="javascript: topicdetailmore2('<?php echo $user_model->id; ?>')" style="cursor: pointer;font-family: Arial;font-size: 13px;">About</div>
    <div style="padding-left: 10px;">
     <div onclick="javascript: topicdetailmore2('<?php echo $user_model->id; ?>')" style="margin-top:5px;margin-bottom:5px; font:14px Arial; cursor: pointer;color: #065A95;"><?php echo $user_model->username;?></div>
      <div class="tagtext">
      <?php
      ...
      <div onclick="javascript: topicdetailmore2('<?php echo $user_model->id; ?>')" style="cursor: pointer;color: #065A95;">More</div>

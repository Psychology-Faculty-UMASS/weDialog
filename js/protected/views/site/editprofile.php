 ...
 <div class="login">
        ...
        <table id="login_detail" border="0" cellpadding="4" cellspacing="0" width="100%">
          ...
          <tr>
                ...
                <td>
                    <?php echo $form->textArea($UserEditModel,'user_description',array("class"=>"input_box"));?>
                </td>
          </tr>
          <tr>
            <td align="right" width="21%" class="title_font_size">As an individual I am: </td>
            <td width="79%">
            <select class="populate select2-offscreen tag1" style="width:450px" id="Users_aiia_discriptor" name="Users[aiia_discriptor][]" multiple="" tabindex="-1">
			<?php 
          ...
          <tr>
            ...
            <td width="79%">
            <select class="populate select2-offscreen tag1" style="width:450px" id="Users_favorite_rule" name="Users[favorite_rule][]" multiple="" tabindex="-1">
			<?php 
        ...
        ?>  
          ...
          <tr>
            ...
            <td>
                <?php echo $form->textField($UserEditModel,"email",array("class"=>"input_box"));?>

...
$this->breadcrumbs=array(
	'Rule Comment Flags'=>array('Admin'),
	'Manage',
);

$this->menu=array(
	array('label'=>'List TypeTagsCommentFlag', 'url'=>array('Admin')),
	array('label'=>'Create TypeTagsCommentFlag', 'url'=>array('create')),
);
?>
<div class="admin_login_form_titel" style="width:98%">
        <table width="100%">
            <tr>
                <td>Manage Rule Comment Flag</td>
                <td></td>
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
        ...
        array(
            'header'=>'Post',
            'name'=>'type_tags_comment_id',
            'value' => 'CHtml::link($data->relation_type_tags_comment_id->comment,Yii::app()->createUrl("TypeTags/viewrule",array("tag_id"=>$data->relation_type_tags_comment_id->type_tag_id )), array("target"=>"_blank","style"=>"color: #065A95;font-size: 14px; font-weight: bold; text-decoration: none;"))',
            'type'  => 'raw',
        ),
        array(
            'header'=>'Author',
...
<form name="checked_items" method="POST" action="<?php echo Yii::app()->createUrl('TypeTagsCommentFlag/Manage_coment'); ?>">

...
?>
   ...
   <div class="admin_login_form_titel" style="width:98%">
        <table width="100%">
            <tr>
                <td>Manage Dialogs</td>
                <td></td>
                <td style="float: right;"> 
                    <span> 
                        <a href="<?php echo Yii::app()->createUrl('dialogs/create'); ?>" style="text-decoration: none"  title="New create record">
   ...
   <div class="admin_login_form_box_details">
        ...
        <?php $this->widget('zii.widgets.grid.CGridView', array(
            ...
            'columns'=>array(
                ...
                array(
                        'name' => 'user_id',
                        'value'=>'$data->dialogs_username->username',
...
<form name="checked_items" method="POST" action="<?php echo Yii::app()->createUrl('dialogs/manage_topics'); ?>">

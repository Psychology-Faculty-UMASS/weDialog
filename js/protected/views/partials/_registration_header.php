<div class="header">
    <div class="header_main">
      <a href="<?php echo Yii::app()->createAbsoluteUrl('dialogs/DialogList'); ?>">
        <div class="logo">
            <img src="<?php echo Yii::app()->baseUrl;?>/images/logo_2015-12-22-12-43PM.png">
            <?php if(!empty(Yii::app()->session['dialog_name'])): ?>
              <?php if(!empty(Yii::app()->session['dialog_created_by']) && !empty(Yii::app()->session['user_id']) && (Yii::app()->session['dialog_created_by']==Yii::app()->session['user_id']) || Yii::app()->session['group_id']==1): ?>
                  <a href="<?php echo Yii::app()->createUrl('dialogs/updatedialog', array('dialog_id'=>Yii::app()->session['dialog_id'])); ?>"><span><?php echo Yii::app()->session['dialog_name']; ?></span></a>
      ...
      <!--
      <div class="banner-logo" style="width:20px;height:20px;margin-left:125px;">
      -->
      ...
      <div style="float:right; position:relative; width:20%;">
	     <ul class="topmenu1" >
			...
			?>
			<li>
				<a <?php if($this->action->id == 'updateAdmin'){?> style="color: #FFF;" <?php }?> href="<?php echo Yii::app()->createUrl('Admin/updateAdmin',array("id"=>$this->data['user_id']));?>">
					Admin
				</a>
			</li>
                        <?php
			...
			?>
                            <li>
                                <a <?php if($this->action->id == 'admin'){?> style="color: #FFF;" <?php }?> href="<?php echo Yii::app()->createUrl('admin',array("id"=>$this->data['user_id']));?>">
                                        Admin
                                </a>
                            </li>
			<?php
  ...
  <!--<div class="header">
    <div class="header_main">
      <div class="logo" >passio<span>net</span>
      	<div class="slogan">Discuss what you are passionat about</div>
      </div>
      <div class="logo" ><div style="text-align: center;"><div style="text-align: center;"><span style="font-family: Verdana; font-weight: bold;"><span style="color: rgb(204, 153, 51);">passio</span><span style="color: rgb(51, 51, 255);">net</span></span><span style="font-family: Verdana;"><span style="color: rgb(51, 51, 255);"><small><small><small><small><small><span style="color: black; font-family: Arial Narrow;"></span></small></small></small></small></small></span></span><br /><span style="font-family: Verdana;"><span style="color: rgb(51, 51, 255);"><small><small><small><small><small><span style="color: black; font-family: Arial Narrow;">Discuss what you are passionate about</span></small></small></small></small></small></span></span><span style="font-family: Verdana;"><span style="color: rgb(51, 51, 255);"></span></span><br style="font-family: Helvetica,Arial,sans-serif;" /></div><span style="font-family: Verdana; font-weight: bold;"><span style="color: rgb(51, 51, 255);"></span></span></div>

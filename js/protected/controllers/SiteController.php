...
class SiteController extends Controller{
    ...
    public function actionDisplayPeople($people_id)
    {
        $id = $people_id;
        $UserProfileModel= Users::model()->findByPk($id);
                                                    ...
                                                    <td style="width:100%; vertical-align: top;">
                                                        <table width="100%" style="vertical-align: top;padding: 0px;" cellspacing="0" cellpadding="0" border="0">
                                                            <tr style="vertical-align: top;">
                                                                <td style=" float:left;font-size:18px;font-weight: bold;"><a href='.Yii::app()->createUrl('site/DisplayPeople',array('people_id'=>$PeopleList->id)).' style="text-decoration: none;color: #065A95 !important;font-size: 14px;">'.$PeopleList->username.'</a></td>    
                                                            </tr>
                                                            <tr>

                                                                ...
                                                                <td>
                                                                    ...
                                                                    <tr style="float:right;width:100%;">
                                                                       ...
                                                                       $data_str .='
                                                                                ...
                                                                                <div style="float:left;width: 20%;">
                                                                                    <div class="postareply" id="showtbldetail1_'.$alltopic->id.'_'.$cnt.'" style="color: #999999;font-family: Arial,Helvetica,sans-serif; font-size: 13px;float:left;margin-top:3px;" >
                                                                                ...
                                                                                <div style="float:left;width: 20%;">
																					...
																					<a class="twitter popup" href="https://twitter.com/intent/tweet?url=http://'.$_SERVER["SERVER_NAME"].'/wedialog/topics/Viewtopic?topic_id='.$topic_id.'"><img src="'.Yii::app()->baseurl.'/images/twitter_icon.png"/></a>
                                                                                </div>
                                                                               <div style="float:left;width: 40%;">
                                                                                    ...
                                                                                    <input type="hidden" id="usercomment_'.$alltopic->id.'" name="user_comment_'.$alltopic->id.'" value="'.$alltopic->user_comment->username.'" />
																						<div style="float:right;">
																							<div class="flagclass"  id="flag_'.$alltopic->id.'" style="cursor: pointer;;float:right;color: #999999;;font-size: 13px;" onclick="showhide('.$alltopic->id.');">Report ';
                                                                                            if($green_cnt >0 OR $red_cnt > 0){
                                                                $data_str .=                       '('.($green_cnt+$red_cnt).')';    
                                                                                            }
                                                                $data_str .=               '</div>
                                                                                            <div style="clear:both"></div>
																							<div class="flagclass_sub" id="flagsub_'.$alltopic->id.'" style="display:none;border:1px solid #999999;padding: 3%;border-radius: 5px;"><a href="javascript:void(0);" onclick="javascript:setFlagMessage('.$alltopic->id.',\'Green\');" style="text-decoration: none;color:#999999;font-size: 13px;">Green Flag ';
                                                                                            if($green_cnt >0){
                                                                $data_str .=                       '('.($green_cnt).') ';    
                                                                                            }
                                                                $data_str .=               '</a><br/>
                                                                                            <a href="javascript:void(0);" onclick="setFlagMessage('.$alltopic->id.',\'Red\');" style="text-decoration: none;color:#999999;font-size: 13px;">Red Flag ';
                                                                                            if($red_cnt >0){
                                                                $data_str .=                       '('.($red_cnt).') ';    
                                                                                            }
				...
				if($record_cnt > 0){
					foreach($TopicListModel as $topic_record){
                       ...
                       if($_POST['currect_section'] == "alltopics" || $_POST['currect_section'] == "popular"){
                        ...
                        $Topic_description=substr($topic_record->topic_description,0, 100);
                        if(strlen($topic_record->topic_description) > 100){
                            $Topic_description.= "...";
                        }
		    			...
		    			$data_str .= '<div class="topic1" id='. $topic_record->id.'>
                                        <h2 style="font-family: Tahoma;">
                                            ...
                                            <a href='.Yii::app()->createUrl('topics/Viewtopic',array('topic_id'=>$topic_record->id)).' style="text-decoration: none;color: #065A95;font: 16px;">
            					    			'.$topic_record->topic_title.'
                                            </a>                                        
                                        </h2>
                                        <p class="toptext">'.$Topic_description .'</p>
                                        <p class="topictext">
                                            <div style="color: rgb(153, 153, 153);" class="datetime">
                                                <font size="-1">
                                                    Posts('.$topic_record->Totalcommentscount.')&nbsp;&nbsp;Latest:'.$fulldate.'
                                                </font>          
                                            </div>           
                                        </p>
                                      </div>';
    ...
    public function actionCreateSSOUrl()
    {
        if(isset($_POST['uid']) && !empty($_POST['uid'])) {
            ...
            if($userId == Yii::app()->session['user_id']) {
                ...
                echo "http://umassamherst.co1.qualtrics.com/SE/$query&Q_JFE=0";
                die;
            }
            else {

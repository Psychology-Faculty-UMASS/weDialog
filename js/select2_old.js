...
(function ($, undefined) {
    ...
    AbstractSelect2 = clazz(Object, {
        ...
        // abstract
        init: function (opts) {
            var results, search, resultsSelector = ".select2-results", enabled;
    ...
    SingleSelect2 = clazz(AbstractSelect2, {
        ...
        createContainer: function () {
            var container = $(document.createElement("div")).attr({
                ...
                "</a>",
                "<input class='select2-focusser select2-offscreen' readonly='readonly' type='text'/>",
                "<div class='select2-drop select2-display-none'>",
                "   <div class='select2-search'>",
                "       <input type='text' autocomplete='off' autocorrect='off' autocapitalize='off' readonly='readonly' spellcheck='false' class='select2-input'/>",
                "   </div>",
    ...
    MultiSelect2 = clazz(AbstractSelect2, {
        ...
        createContainer: function () {
            var container = $(document.createElement("div")).attr({
                ...
                "    <input type='text' autocomplete='off' autocorrect='off' readonly='readonly' autocapitilize='off' spellcheck='false' class='select2-input'>",
                "  </li>",
                "</ul>",

				...
				if(count($user_comment_model)>0){
					foreach($user_comment_model as $allrule){
                        ...
                        if(!empty($allrule->comment)){
                            ...
                            $commentMore.= "<span style='text-align: justify;color: #666666;font-family: Arial,Helvetica,sans-serif; font-size: 14px; word-break: break-word;' id='comment-less-txt-".$allrule->id."'>".$comText."</span>";
                                if(strlen($allrule->comment) > 700){
                                   ...
                                   $commentMore.= "<span style='display:none; text-align: justify;color: #666666;font-family: Arial,Helvetica,sans-serif; font-size: 14px;' class='comment_desc_hidden_text_".$allrule->id."'>".nl2br($allrule->comment)."</span>";
                        ...
                        $data_str .= '</td>
                                                    ...
                                                    <tr style="display:none" data-show="none" class="c-post-text-edit-form" id="c-post-text-edit-form-'.$allrule->id.'" data-id="'.$allrule->id.'">
                                                        <td>
                                                            <textarea id="c-post-text-edit-comment-area-'.$allrule->id.'" name="c-post-text-edit-comment-area" style="width:100%; height:250px; resize: none; font-size:14px; font-family: Arial,Helvetica,Tahoma,sans-serif;">'.strip_tags($allrule->comment,'<br></br><br/>').'</textarea>
                                                            <br/>
                ...
                $data_str .= '</td>
                                            <td style="vertical-align: top;">
                                                <table style="width:100%">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <span style="text-align: justify;color: #666666;font-family: Arial,Helvetica,sans-serif; font-size: 14px;">'.strip_tags(nl2br($allrule->comment),'<br></br><br/><a>').'</span>
                                                        </td>
                                                    </tr>
    											   <tr id="already_voted_message_'.$allrule->id.'" style="background-color: #FFFA9D;display:none;border:1px solid #666666;width:128px"><td style="color:#666666;font-size: 14px;text-align: center;" colspan="2">You already voted!</td></tr>
    	                                            <tr style=" width:558px; padding-left:25px;">

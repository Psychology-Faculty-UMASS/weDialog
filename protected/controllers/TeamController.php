...
class TeamController extends Controller
{
    ...
    public function actionTeamlist(){
       ...
       $teammodel =Team::model()->findAll(array('condition'=>'dialog_id=:did','order'=>'members DESC', 'params'=>array(':did'=>$dialogID)));
    ...
    public function actionPagination(){
       ...
       $teammodel =Team::model()->findAll(array('condition'=>'dialog_id=:did','order'=>$_POST['list_by'].' DESC', 'params'=>array(':did'=>$dialogID)));
    ...
    public function actionUpdateteam($id=''){
        $this->layout = 'registration';
        if(isset($this->data['group_id']) && $this->data['group_id']=="1" || $this->data['group_id']=="3")
        {
            $team_model = Team::model()->find(array('condition'=>'id='.$id));
        }
        else
        {
    ...
    public function actionViewteam($id=''){
		...
		if(!empty($_POST)){
			...
			if(isset($_POST['comment_id']) && $_POST['comment_id']!=0){
				...
				$post_comment_array['comment'] = strip_tags(html_entity_decode($_POST['replycomment_'.$tmp_comment_id]),'<br></br><br/>');
				...
				require_once(dirname(Yii::app()->request->scriptFile).'/protected/extensions/htmlpurifier/library/HTMLPurifier.auto.php');
                                ...
                                $config->set('AutoFormat', 'Linkify', true);
                                $purifier = new HTMLPurifier($config);
				$post_comment_array['comment'] = strip_tags(html_entity_decode($_POST['post_comment_area']), '<br></br><br/>');
                                $post_comment_array['comment'] = $purifier->purify($post_comment_array['comment']);
			}
                        ...
                        $data_str .= '</td>
                                                    <td style="vertical-align: top;">
                                                        <table style="width:100%">
                                                            <tr>
                                                                <td>
                                                                    <span style="color:#065A95;font-family: Arial,Helvetica,sans-serif;" >
                                                                        <a target="_blank" href="'.Yii::app()->createUrl('site/viewpeople',array('people_id'=>$allteam->user_comment->id)).'" style="color: #065A95; font-weight: bold; text-decoration: none;">'.ucfirst($allteam->user_comment->username).'</a>';
                                                                        if($allteam->comment_id != 0){
                                                                            $data_str .= '<span style="color:#065A95;"> > @ </span><a target="_blank" href="'.Yii::app()->createUrl('site/viewpeople',array('people_id'=>$allteam->team_other_comment->user_comment->id)).'" style="color: #065A95; text-decoration: none;">'.ucfirst($allteam->team_other_comment->user_comment->username).'</a>';
                                                                        }
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <span style="text-align: justify;color: #666666;font-family: Arial,Helvetica,sans-serif;">'.$allteam->comment.'</span>
                                                                </td>
                                                            </tr>
            											   <tr id="already_voted_message_'.$allteam->id.'" style="background-color: #FFFA9D;display:none;border:1px solid #666666;width:128px"><td style="color:#666666;text-align: center;" colspan="2">You already voted!</td></tr>
                                                                        ...
                                                                        <td style="width:100%">
                                                                            <div>
                                                                                <div style="float:left;width: 40%;">
                                                                                    <img src="'.Yii::app()->baseUrl.'/images/newgreen.jpg" id="greenup" alt="" onclick="javascript:likedislikecommentfun('.$allteam->id.', \'like\')" style="cursor:pointer;"/>
                                                                                    <span id="likecount_'.$allteam->id.'" style="color: #999999;font-family: Arial,Helvetica,sans-serif;">'.$allteam->like.'</span>&nbsp&nbsp&nbsp&nbsp;
                                                                                    <img src="'.Yii::app()->baseUrl.'/images/newred.jpg" id="reddown" alt="" onclick="javascript:likedislikecommentfun('.$allteam->id.',\'dislike\')" style="cursor:pointer;" />
                                                                                    <span id="dislikecount_'.$allteam->id.'" style="color: #999999;font-family: Arial,Helvetica,sans-serif; ">'.$allteam->dislike.'</span>
                                                                               	</div>
                                                                                <div style="float:left;width: 10%;">
                                                                                    <div class="postareply" id="showtbldetail1_'.$allteam->id.'_'.$cnt.'" style="color: #999999;font-family: Arial,Helvetica,sans-serif; float:left;margin-top:3px;" >
                                                                                ...
                                                                                <div style="float:left;width: 20%;">
																					...
																					<style> html .fb_share_button { display: -moz-inline-block; display:inline-block; padding:1px 20px 0 35px; height:15px; border:1px solid #d8dfea; background:url('.Yii::app()->baseUrl.'/images/facebook_share_icon.gif) no-repeat top right; } html .fb_share_button:hover { color:#fff; border-color:#295582; background:url('.Yii::app()->baseUrl.'/images/facebook_share_icon.gif) no-repeat top right; text-decoration:none; } </style> 
                                                                                    <a rel="nofollow" href="https://www.facebook.com/sharer.php?u=http://'.$_SERVER["SERVER_NAME"].'/wedialog/Team/viewteam?id='.$team_id.'" class="fb_share_button" onclick="return fbs_click()" target="_blank" style="text-decoration:none;padding:0px 10px 0px 35px;"></a> 
																					<a class="twitter popup" href="http://twitter.com/share"><img src="'.Yii::app()->baseurl.'/images/twitter_icon.png"/></a>
                                                                                </div>
                                                                               <div style="float:left;width: 30%;">
                                                                                    
                                                                                    <input type="hidden" id="usercomment_'.$allteam->id.'" name="user_comment_'.$allteam->id.'" value="'.$allteam->
																					user_comment->username.'" />
																						<div style="float:right;">
																							<div class="flagclass"  id="flag_'.$allteam->id.'" style="cursor: pointer; float:right;color: #999999;" onclick="showhide('.$allteam->id.');">Flag ';
                                                                                            if($green_cnt >0 OR $red_cnt > 0){
                                                                $data_str .=                       '('.($green_cnt+$red_cnt).')';    
                                                                                            }
                                                                $data_str .=               '</div>
                                                                                            <div style="clear:both"></div>
																							<div class="flagclass_sub" id="flagsub_'.$allteam->id.'" style="display:none;border:1px solid #999999;padding: 3%;border-radius: 5px;"><a href="javascript:void(0);" onclick="javascript:setFlagMessage('.$allteam->id.',\'Green\');" style="text-decoration: none;color:#999999; ">Green Flag ';
                                                                                            if($green_cnt >0){
                                                                $data_str .=                       '('.($green_cnt).') ';    
                                                                                            }
                                                                $data_str .=               '</a><br/>
                                                                                            <a href="javascript:void(0);" onclick="setFlagMessage('.$allteam->id.',\'Red\');" style="text-decoration: none;color:#999999; ">Red Flag ';
                                                                                            if($red_cnt >0){
                                                                $data_str .=                       '('.($red_cnt).') ';    
                                                                                            }
            															...
            															<table style="width:100%; vertical-align: top;">
            																<tr>
            																	<td id="reply_comment_id_'.$allteam->id.'">
            																		<textarea id="replycomment_'.$allteam->id.'" name="replycomment_'.$allteam->id.'" style="width:100%; height:250px;font-family:Arial,Helvetica,Tahoma,sans-serif; padding: 1%;"></textarea>
            																	</td>
            																</tr>
            																<tr>
            																	<td>
                        ...
                        $data_str .= '<a target="_blank" href="'.Yii::app()->createUrl("Site/viewpeople", array("people_id"=>$team_model->user_id,"type"=>"red")).'" style="text-decoration:none;">
                                        <div style="background-color:#FA3002; color:white; font-size:11px; width:20px;height:12px; float:left; text-align:center;" title="'.$red_total_cooment.' Red  Flags">
                                            <div style="margin-top:-3px; font-size:11px;">'.$red_total_cooment.'</div>
                                                         ...
                                                         $commentMore = '';
                        if(!empty($allteam->comment)){
                            //echo $TopicList->topic_description;
                            $url = '@(http)?(s)?(://)?(([a-zA-Z])([-\w]+\.)+([^\s\.]+[^\s]*)+[^,.\s])@';
                            $comText = nl2br(myhelpers::get_cropped_text($allteam->comment, 700));
                            if(strlen($allteam->comment) > 700){
                                $comText = strip_tags($comText,'<br></br><br/>');
                            }
                            //$comText = preg_replace($url, '<a href="http$2://$4" target="_blank" title="$0">$0</a>', $comText);
                            $commentMore.= "<span style='text-align: justify;color: #666666;font-family: Arial,Helvetica,sans-serif; word-break: break-word;' id='comment-less-txt-".$allteam->id."'>".$comText."</span>";
                                if(strlen($allteam->comment) > 700){
                                    $comMoreText = nl2br(myhelpers::get_cropped_more_text($allteam->comment, 700));
                                    //$comMoreText = preg_replace($url, '<a href="http$2://$4" target="_blank" title="$0">$0</a>', $comMoreText);
                                   $commentMore.= "<span class='comment_desc_more_dots_".$allteam->id."' data-id='".$allteam->id."'>...</span>";
                                   $commentMore.= "<span style='display:none; text-align: justify;color: #666666;font-family: Arial,Helvetica,sans-serif;' class='comment_desc_hidden_text_".$allteam->id."'>".nl2br($allteam->comment)."</span>";
                                   $commentMore.= "<a id='comment_desc_more_".$allteam->id."' class='comment_desc_more' data-id='".$allteam->id."'>More</a>";
                                   $commentMore.= "<a id='comment_desc_less_".$allteam->id."' class='comment_desc_less' style='display:none' data-id='".$allteam->id."'>Less</a>";
                                   $commentMore.= "<br/>";
                                }
                        } 
                        else{
                                                    ...
                                                    <td style="vertical-align: top;">
                                                        <table style="width:100%">
                                                            <tr>
                                                                <td>
                                                                    <span style="color:#065A95;font-family: Arial,Helvetica,sans-serif ;" >
                                                                        ...
                                                                        if($allteam->comment_id != 0){
                                                                            ...
                                                                            $data_str .= '<span style="'.$color.'"> - '.date('m/d/y',$stringtime).'-'.date('H:i',$stringtime).'</span>';
                                                                        if(Yii::app()->session['user_id']==$allteam->user_id){
                                                                            $data_str .= '<span class="c-edit-post-button" data-id="'.$allteam->id.'" style="float:right; cursor:pointer;   color:#999999; margin-right:8px;">Edit</span>';
                                                             ...
                                                             <tr class="c-post-text" id="c-post-text-'.$allteam->id.'" data-id="'.$allteam->id.'">
                                                                <td>'.
                                                                    $commentMore
                                                                .'</td>
                                                            </tr>
                                                            <tr style="display:none;" data-show="none" class="c-post-text-edit-form" id="c-post-text-edit-form-'.$allteam->id.'" data-id="'.$allteam->id.'">
                                                                <td>
                                                                    <textarea id="c-post-text-edit-comment-area-'.$allteam->id.'" name="c-post-text-edit-comment-area" style="width:100%; height:250px; resize: none; font-family: Arial,Helvetica,Tahoma,sans-serif;">'.strip_tags($allteam->comment,'<br></br><br/>').'</textarea>
                                                                    <br/>
                                                                    <input value="Post" class="type c-post-text-submit-post" data-id="'.$allteam->id.'" style="float: right;" type="submit">
                                                                </td>
                                                            </tr>
			...
			foreach($allteam->team_main_comment_list as $allteam){
                ...
                $data_str .= '<a target="_blank" href="'.Yii::app()->createUrl("Site/viewpeople", array("people_id"=>$team_model->user_id,"type"=>"red")).'" style="text-decoration:none;">
                        ...
                        if(!empty($allteam->comment)){
                            ...
                            //$comText = preg_replace($url, '<a href="http$2://$4" target="_blank" title="$0">$0</a>', $comText);
                            $commentMore.= "<span style='text-align: justify;color: #666666;font-family: Arial,Helvetica,sans-serif; font-size:  ; word-break: break-word;' id='comment-less-txt-".$allteam->id."'>".$comText."</span>";
                                if(strlen($allteam->comment) > 700){
                                    $comMoreText = nl2br(myhelpers::get_cropped_more_text($allteam->comment, 700));
                                    //$comMoreText = preg_replace($url, '<a href="http$2://$4" target="_blank" title="$0">$0</a>', $comMoreText);
                                   $commentMore.= "<span class='comment_desc_more_dots_".$allteam->id."' data-id='".$allteam->id."'>...</span>";
                ...
                $data_str .= '</td>
                                            <td style="vertical-align: top;">
                                                <table style="width:100%">
                                                    <tr>
                                                        <td>
                                                            <span style="color:#065A95;font-family: Arial,Helvetica,sans-serif; font-size:  ;" >
                                                                <a target="_blank" href="'.Yii::app()->createUrl('site/viewpeople',array('people_id'=>$allteam->user_comment->id)).'" style="color: #065A95; font-weight: bold; text-decoration: none;">'.ucfirst($allteam->user_comment->username).'</a>';
                                                                if($allteam->comment_id != 0){
                                                                    $data_str .= '<span style="color:#065A95;"> > @ </span><a target="_blank" href="'.Yii::app()->createUrl('site/viewpeople',array('people_id'=>$allteam->team_other_comment->user_comment->id)).'" style="color: #065A95; text-decoration: none;">'.ucfirst($allteam->team_other_comment->user_comment->username).'</a>';
                                                                }
                                                                        ...
                                                                        <td style="width:100%">
                                                                            <div>
                                                                                ...
                                                                                <div style="float:left;width: 20%;">
                                                                                    <script>function fbs_click() {u=location.href;t=document.title;window.open("https://www.facebook.com/sharer.php?u=+encodeURIComponent(u)+&t=+encodeURIComponent(t)",sharer,toolbar=0,status=0,width=626,height=436);return false;}</script>
																					<style> html .fb_share_button { display: -moz-inline-block; display:inline-block; padding:1px 20px 0 35px; height:15px; background:url('.Yii::app()->baseUrl.'/images/facebook_share_icon.gif) no-repeat top right; } html .fb_share_button:hover { color:#fff;  background:url('.Yii::app()->baseUrl.'/images/facebook_share_icon.gif) no-repeat top right; text-decoration:none; } </style> 
                                                                                    <a rel="nofollow" href="https://www.facebook.com/sharer.php?u=http://'.$_SERVER["SERVER_NAME"].'/wedialog/Team/viewteam?id=1'.$team_id.'" class="fb_share_button" onclick="return fbs_click()" target="_blank" style="text-decoration:none;padding:0px 10px 0px 35px;"></a> 
																					<a class="twitter popup" href="http://twitter.com/share"><img src="'.Yii::app()->baseurl.'/images/twitter_icon.png"/></a>
                                                                                </div>
                                                                               <div style="float:left;width: 30%;">

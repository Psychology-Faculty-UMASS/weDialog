...
class TypeTagsController extends Controller
{
  ...
  public function actionViewthreadcomment(){
                                                                ...
                                                                <td>
                                                                    <span style="color:#065A95;font-family: Arial,Helvetica,sans-serif; font-size: 14px;" >
                                                                        ...
                                                                        if(Yii::app()->session['user_id']==$allrule->user_id){
                                                                            $data_str .= '<span class="c-edit-post-button" data-id="'.$allrule->id.'" style="float:right; cursor:pointer; font-size: 13px; color:#999999; margin-right:8px;">Edit</span>';
    ...
    public function actionUpdatetypetags($tag_id=''){
        $this->layout = 'registration';
        if(isset($this->data['group_id']) && $this->data['group_id']=="1" || data['group_id']=="3")
        {

                                                                    ...
                                                                    <tr style="float:right;width:100%;">
                                                                       ...
                                                                       $data_str .='
                                                                                <div style="float:left;width: 20%;">
                                                                                    <img src="'.Yii::app()->baseUrl.'/images/newgreen.jpg" alt="" onclick="javascript:likedislikecommentfun('.$alltopic->id.', \'like\')" style="cursor:pointer; width:18px;"/>
                                                                                    <span id="likecount_'.$alltopic->id.'" style="color: #999999;font-family: Arial,Helvetica,sans-serif; font-size: 15px;">'.$green_vote_count.'</span>&nbsp&nbsp&nbsp&nbsp;
                                                                                    <img src="'.Yii::app()->baseUrl.'/images/newred.jpg" onclick="javascript:likedislikecommentfun('.$alltopic->id.',\'dislike\')" style="cursor:pointer; width:18px;" />
                                                                                    <span id="dislikecount_'.$alltopic->id.'" style="color: #999999;font-family: Arial,Helvetica,sans-serif; font-size: 15px;">'.$red_vote_count.'</span>
                                                                               	</div>
                                                                                <div style="float:left;width: 20%;">
                                                                                    <div class="postareply" id="showtbldetail1_'.$alltopic->id.'_'.$cnt.'" style="color: #999999;font-family: Arial,Helvetica,sans-serif; font-size: 15px;float:left;margin-top:-1px;" >
                                                                               ...
                                                                               <div style="float:left;width: 40%;">
                                                                                    ...
                                                                                    <input type="hidden" id="usercomment_'.$alltopic->id.'" name="user_comment_'.$alltopic->id.'" value="'.$alltopic->user_comment->username.'" />
																						<div style="float:right;">
																							<div class="flagclass"  id="flag_'.$alltopic->id.'" style="cursor: pointer;;float:right;color: #999999;;font-size: 15px;" onclick="showhide('.$alltopic->id.');">Flag ';
                                                                                            if($green_cnt >0 OR $red_cnt > 0){
                                                                $data_str .=                       '('.($green_cnt+$red_cnt).')';    
                                                                                            }
                                                                $data_str .=               '</div>
                                                                                            <div style="clear:both"></div>
																							<div class="flagclass_sub" id="flagsub_'.$alltopic->id.'" style="display:none;border:1px solid #999999;padding: 3%;border-radius: 5px;"><a href="javascript:void(0);" onclick="javascript:setFlagMessage('.$alltopic->id.',\'Green\');" style="text-decoration: none;color:green;font-size: 15px; font-color:"green";">&#9607 Green ';
                                                                                             if($green_cnt >0){
                                                                $data_str .=                       '('.($green_cnt).') ';    
                                                                                            }
                                                                $data_str .=               '</a><br/>
                                                                                            <a href="javascript:void(0);" onclick="setFlagMessage('.$alltopic->id.',\'Red\');" style="text-decoration: none;color:#999999;font-size: 15px;font-color:"red";">&#9607 Red ';
                                                                                            if($red_cnt >0){
                                                                $data_str .=                       '('.($red_cnt).') ';    
                                                                                            }
					...
					foreach($user_comment_model as $alltopic){
                       ...
                       /*Start For filter to display only liked and disliked users post for Vote filter only */
                        ...
                        if(!empty($alltopic->comment)){
                            ...
                            $commentMore.= "<span style='word-break: break-word;' id='comment-less-txt-".$alltopic->id."'>".$comText."</span>";
                                if(strlen($alltopic->comment) > 700){
                                   ...
                                   $commentMore.= "<span style='display:none;' class='comment_desc_hidden_text_".$alltopic->id."'>".nl2br($alltopic->comment)."</span>";
                                                                ...
                                                                <td>
                                                                    <span style="color:#065A95;font-family: Arial,Helvetica,sans-serif; font-size: 14px;" >
                                                                        ...
                                                                        if(Yii::app()->session['user_id']==$alltopic->user_id){
                                                                            $data_str .= '<span class="c-edit-post-button" data-id="'.$alltopic->id.'" style="float:right; cursor:pointer; font-size: 15px; color:#999999; margin-right:8px;">Edit</span>';
...
Same needs to also work for Hide Reply, below*/
                                                            ...
                                                            <tr style="display:none;" data-show="none" class="c-post-text-edit-form" id="c-post-text-edit-form-'.$alltopic->id.'" data-id="'.$alltopic->id.'">
                                                                <td>
                                                                    <textarea id="c-post-text-edit-comment-area-'.$alltopic->id.'" name="c-post-text-edit-comment-area" style="width:100%; height:250px; resize: none; ">'.strip_tags($alltopic->comment,'<br></br><br/>').'</textarea>
                                                                    <br/>
            											   ...
            											   <tr id="already_voted_message_'.$alltopic->id.'" style="background-color: #FFFA9D;display:none;border:1px solid #666666;width:128px"><td style="color:#666666;font-size: 14px;text-align: center;" colspan="2">You already voted!</td></tr>
            	                                            <tr style=" width:558px; padding-left:25px;">
                                                                ...
                                                                $data_str .=               '</a><br/>
                                                                                            <a href="javascript:void(0);" onclick="setFlagMessage('.$alltopic->id.',\'Red\');" style="text-decoration: none;color:red;font-size: 15px; font-color:"red";">&#9607 Red ';
                                                                                            if($red_cnt >0){
                                                                $data_str .=                       '('.($red_cnt).') ';    
                                                                                            }
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <span style="color:#065A95;font-family: Arial,Helvetica,sans-serif; font-size: 14px;" >
                                                                ...
                                                                if(Yii::app()->session['user_id']==$alltopic->user_id){
                                                                    $data_str .= '<span class="c-edit-post-button" data-id="'.$alltopic->id.'" style="float:right; cursor:pointer; font-size: 15px; color:#999999; margin-right:8px;">Edit</span>';
 //                                                                   $data_str .= '<span class="c-edit-post-button" data-id="'.$alltopic->id.'" style="float:right; cursor:pointer; font-size: 15px; color:#999999; margin-right:8px;">Hide</span>';
//<style="cursor: pointer;;float:right;color: #999999;;font-size: 15px;" onclick="setFlagMessage('.$alltopic->id.',\'Red\');">Report ';
                                                                }
                                                            $data_str .= '</span>
                                                        </td>
                                                    </tr>

                                                                    ...
                                                                    <tr style="float:right;width:100%;">
                                                                       ...
                                                                       $data_str .='
                                                                                ...
                                                                                <div style="float:left;width: 20%;">
                                                                                    <div class="postareply" id="showtbldetail1_'.$alltopic->id.'_'.$cnt.'" style="color: #999999;font-family: Arial,Helvetica,sans-serif; float:left;margin-left:30px;" >
                                                                                ...
                                                                                <div class="post-share" style="float:left;width: 20%;">
																					...
																					<style> html .fb_share_button { display: -moz-inline-block; display:inline-block; margin-left:30px; padding:1px 20px 0 5px; height:15px; border:1px solid #d8dfea; background:url('.Yii::app()->baseUrl.'/images/facebook_share_icon.gif) no-repeat top right; } html .fb_share_button:hover { color:#fff; border-color:#295582; background:url('.Yii::app()->baseUrl.'/images/facebook_share_icon.gif) no-repeat top right; text-decoration:none; } </style> 
                                                                                    <a rel="nofollow" href="https://www.facebook.com/sharer.php?u=http://'.$_SERVER["SERVER_NAME"].'/wedialog/topics/Viewtopic?topic_id='.$topic_id.'" class="fb_share_button" onclick="return fbs_click()" target="_blank" style="text-decoration:none;margin-left:30px; padding:0px 10px 0px 5px;"></a> 
            															...
            															<table style="width:100%; vertical-align: top;">
            																<tr>
            																	<td id="reply_comment_id_'.$alltopic->id.'">
            																		<textarea id="replycomment_'.$alltopic->id.'" name="replycomment_'.$alltopic->id.'" style="width:100%; height:250px;font-family:Arial,Helvetica,Tahoma,sans-serif;padding: 1%;"></textarea>
            																	</td>
            																</tr>
            																<tr>
            																	<td>
...
Same needs to also work for Hide Reply, below*/
            											   ...
            											   <tr id="already_voted_message_'.$alltopic->id.'" style="background-color: #FFFA9D;display:none;border:1px solid #666666;width:128px"><td style="color:#666666;text-align: center;" colspan="2">You already voted!</td></tr>
            	                                            <tr style=" width:558px; padding-left:25px;">
                                                                ...
                                                                $data_str .=               '</a><br/>
                                                                                            <a href="javascript:void(0);" onclick="setFlagMessage('.$alltopic->id.',\'Red\');" style="text-decoration: none;color:red;font-size: 13px; font-color:"red";">&#9607 Red ';
                                                                                            if($red_cnt >0){
                                                                $data_str .=                       '('.($red_cnt).') ';    
                                                                                            }

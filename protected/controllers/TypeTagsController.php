...
class TypeTagsController extends Controller
{
    ...
    public function actionPagination(){
       ...
       $typetagmodel =TypeTags::model()->findAll(array('condition'=>'dialog_id=:did','order'=>$_POST['list_by'].' DESC','limit' =>$limit, 'params' => array(':did'=>$dialogID)));
                        ...
                        $data_str .= '</td>
                                                    <td style="vertical-align: top;">
                                                        <table style="width:100%">
                                                            <tr>
                                                                <td>
                                                                    <span style="color:#065A95;font-family: Arial,Helvetica,sans-serif;  " >
                                                                        <a target="_blank" href="'.Yii::app()->createUrl('site/viewpeople',array('people_id'=>$allrule->user_comment->id)).'" style="color: #065A95;  font-weight: bold; text-decoration: none;">'.ucfirst($allrule->user_comment->username).'</a>';
                                                                        if($allrule->comment_id != 0){
                                                                            $data_str .= '<span style="color:#065A95;"> > @ </span><a target="_blank" href="'.Yii::app()->createUrl('site/viewpeople',array('people_id'=>$allrule->rule_other_comment->user_comment->id)).'" style="color: #065A95;  text-decoration: none;">'.ucfirst($allrule->rule_other_comment->user_comment->username).'</a>';
                                                                        }
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <span style="text-align: justify;color: #666666;font-family: Arial,Helvetica,sans-serif;  ">'.$allrule->comment.'</span>
                                                                </td>
                                                            </tr>
            											   <tr id="already_voted_message_'.$allrule->id.'" style="background-color: #FFFA9D;display:none;border:1px solid #666666;width:128px"><td style="color:#666666; text-align: center;" colspan="2">You already voted!</td></tr>
                                                                        ...
                                                                        <td style="width:100%">
                                                                            <div>
                                                                                <div style="float:left;width: 40%;">
                                                                                    <img src="'.Yii::app()->baseUrl.'/images/newgreen.jpg" id="greenup" alt="" onclick="javascript:likedislikecommentfun('.$allrule->id.', \'like\')" style="cursor:pointer;"/>
                                                                                    <span id="likecount_'.$allrule->id.'" style="color: #999999;font-family: Arial,Helvetica,sans-serif;  ">'.$allrule->like.'</span>&nbsp&nbsp&nbsp&nbsp;
                                                                                    <img src="'.Yii::app()->baseUrl.'/images/red.jpg"  id="reddown" alt="" onclick="javascript:likedislikecommentfun('.$allrule->id.',\'dislike\')" style="cursor:pointer;" />
                                                                                    <span id="dislikecount_'.$allrule->id.'" style="color: #999999;font-family: Arial,Helvetica,sans-serif;  ">'.$allrule->dislike.'</span>
                                                                               	</div>
                                                                                <div style="float:left;width: 10%;">
                                                                                    <div class="postareply" id="showtbldetail1_'.$allrule->id.'_'.$cnt.'" style="color: #999999;font-family: Arial,Helvetica,sans-serif;  float:left;margin-top:3px;" >
                                                                               ...
                                                                               <div style="float:left;width: 30%;">
                                                                                    ...
                                                                                    <input type="hidden" id="usercomment_'.$allrule->id.'" name="user_comment_'.$allrule->id.'" value="'.$allrule->user_comment->username.'" />
																						<div style="float:right;">
																							<div class="flagclass"  id="flag_'.$allrule->id.'" style="cursor: pointer;;float:right;color: #999999;; " onclick="showhide('.$allrule->id.');">Flag ';
                                                                                            if($green_cnt >0 OR $red_cnt > 0){
                                                                $data_str .=                       '('.($green_cnt+$red_cnt).')';    
                                                                                            }
                                                                $data_str .=               '</div>
                                                                                            <div style="clear:both"></div>
																							<div class="flagclass_sub" id="flagsub_'.$allrule->id.'" style="display:none;border:1px solid #999999;padding: 3%;border-radius: 5px;"><a href="javascript:void(0);" onclick="javascript:setFlagMessage('.$allrule->id.',\'Green\');" style="text-decoration: none;color:#999999; ">Green Flag ';
                                                                                            if($green_cnt >0){
                                                                $data_str .=                       '('.($green_cnt).') ';    
                                                                                            }
                                                                $data_str .=               '</a><br/>
                                                                                            <a href="javascript:void(0);" onclick="setFlagMessage('.$allrule->id.',\'Red\');" style="text-decoration: none;color:#999999; ">Red Flag ';
                                                                                            if($red_cnt >0){
                                                                $data_str .=                       '('.($red_cnt).') ';    
                                                                                            }
            															...
            															<table style="width:100%; vertical-align: top;">
            																<tr>
            																	<td id="reply_comment_id_'.$allrule->id.'">
            																		<textarea id="replycomment_'.$allrule->id.'" name="replycomment_'.$allrule->id.'" style="width:100%; height:250px;font-family:Arial,Helvetica,Tahoma,sans-serif; padding: 1%;"></textarea>
            																	</td>
            																</tr>
            																<tr>
            																	<td>
  ...
  public function actionViewthreadcomment(){
                        ...
                        $data_str .= '<a target="_blank" href="'.Yii::app()->createUrl("Site/viewpeople", array("people_id"=>$allrule->user_id,"type"=>"red")).'" style="text-decoration:none;">
                                        <div style="background-color:#FA3002; color:white; font-size:11px; width:20px;height:12px; float:left; text-align:center;" title="'.$red_total_cooment.' Red  Flags">
                                            <div style="margin-top:-3px; font-size:11px;">'.$red_total_cooment.'</div>
                                                          ...
                                                          $commentMore = '';
                        if(!empty($allrule->comment)){
                            //echo $TopicList->topic_description;
                            $url = '@(http)?(s)?(://)?(([a-zA-Z])([-\w]+\.)+([^\s\.]+[^\s]*)+[^,.\s])@';
                            $comText = nl2br(myhelpers::get_cropped_text($allrule->comment, 700));
                            if(strlen($allrule->comment) > 700){
                                $comText = strip_tags($comText,'<br></br><br/>');
                            }
                            //$comText = preg_replace($url, '<a href="http$2://$4" target="_blank" title="$0">$0</a>', $comText);
                            $commentMore.= "<span style='text-align: justify;color: #666666;font-family: Arial,Helvetica,sans-serif;   word-break: break-word;' id='comment-less-txt-".$allrule->id."'>".$comText."</span>";
                                if(strlen($allrule->comment) > 700){
                                    $comMoreText = nl2br(myhelpers::get_cropped_more_text($allrule->comment, 700));
                                    //$comMoreText = preg_replace($url, '<a href="http$2://$4" target="_blank" title="$0">$0</a>', $comMoreText);
                                   $commentMore.= "<span class='comment_desc_more_dots_".$allrule->id."' data-id='".$allrule->id."'>...</span>";
                                   $commentMore.= "<span style='display:none; text-align: justify;color: #666666;font-family: Arial,Helvetica,sans-serif;  ' class='comment_desc_hidden_text_".$allrule->id."'>".nl2br($allrule->comment)."</span>";
                                   $commentMore.= "<a id='comment_desc_more_".$allrule->id."' class='comment_desc_more' data-id='".$allrule->id."'>More</a>";
                                   $commentMore.= "<a id='comment_desc_less_".$allrule->id."' class='comment_desc_less' style='display:none' data-id='".$allrule->id."'>Less</a>";
                                   $commentMore.= "<br/>";
                                }
                        } 
                        else{
                        ...
                        $data_str .= '</td>
                                                    <td style="vertical-align: top;">
                                                        <table style="width:100%">
                                                                ...
                                                                <td>
                                                                    <span style="color:#065A95;font-family: Arial,Helvetica,sans-serif;  " >
                                                                        ...
                                                                        if($allrule->comment_id != 0){
                                                                            ...
                                                                            $data_str .= '<span style=" '.$color.'"> - '.date('m/d/y',$stringtime).'-'.date('H:i',$stringtime).'</span>';
                                                                        if(Yii::app()->session['user_id']==$allrule->user_id){
                                                                            $data_str .= '<span class="c-edit-post-button" data-id="'.$allrule->id.'" style="float:right; cursor:pointer;   color:#999999; margin-right:8px;">Edit</span>';
                                                            ...
                                                            <tr class="c-post-text" id="c-post-text-'.$allrule->id.'" data-id="'.$allrule->id.'">
                                                        <td>'.
                                                            $commentMore
                                                        .'</td>
                                                    </tr>
                                                    <tr style="display:none" data-show="none" class="c-post-text-edit-form" id="c-post-text-edit-form-'.$allrule->id.'" data-id="'.$allrule->id.'">
                                                        <td>
                                                            <textarea id="c-post-text-edit-comment-area-'.$allrule->id.'" name="c-post-text-edit-comment-area" style="width:100%; height:250px; resize: none;   font-family: Arial,Helvetica,Tahoma,sans-serif;">'.strip_tags($allrule->comment,'<br></br><br/>').'</textarea>
                                                            <br/>
                                                            <input value="Post" class="type c-post-text-submit-post" data-id="'.$allrule->id.'" style="float: right;" type="submit">
                                                        </td>
                                                    </tr>
            											   <tr id="already_voted_message_'.$allrule->id.'" style="background-color: #FFFA9D;display:none;border:1px solid #666666;width:128px"><td style="color:#666666; text-align: center;" colspan="2">You already voted!</td></tr>
            	                                            <tr style=" width:558px; padding-left:25px;">
                                                                        ...
                                                                        <td style="width:100%">
                                                                            <div>
                                                                                <div style="float:left;width: 40%;">
                                                                                    <img src="'.Yii::app()->baseUrl.'/images/newgreen.jpg" id="greenup" alt="" onclick="javascript:likedislikecommentfun('.$allrule->id.', \'like\')" style="cursor:pointer;"/>
                                                                                    <span id="likecount_'.$allrule->id.'" style="color: #999999;font-family: Arial,Helvetica,sans-serif;  ">'.$allrule->like.'</span>&nbsp&nbsp&nbsp&nbsp;
                                                                                    <img src="'.Yii::app()->baseUrl.'/images/newred.jpg" id="reddown" alt=""  onclick="javascript:likedislikecommentfun('.$allrule->id.',\'dislike\')" style="cursor:pointer;" />
                                                                                    <span id="dislikecount_'.$allrule->id.'" style="color: #999999;font-family: Arial,Helvetica,sans-serif;  ">'.$allrule->dislike.'</span>
                                                                               	</div>
                                                                                <div style="float:left;width: 10%;">
                                                                                    <div class="postareply" id="showtbldetail1_'.$allrule->id.'_'.$cnt.'" style="color: #999999;font-family: Arial,Helvetica,sans-serif;  float:left;margin-top:3px;" >
                                                                                ...
                                                                                <div style="float:left;width: 20%;">
                                                                                    <script>function fbs_click() {u=location.href;t=document.title;window.open("https://www.facebook.com/sharer.php?u=+encodeURIComponent(u)+&t=+encodeURIComponent(t)",sharer,toolbar=0,status=0,width=626,height=436);return false;}</script>
																					<style> html .fb_share_button { display: -moz-inline-block; display:inline-block; padding:1px 20px 0 5px; height:15px;  background:url('.Yii::app()->baseUrl.'/images/facebook_share_icon.gif) no-repeat top right; } html .fb_share_button:hover { color:#fff; border-color:#295582; background:url('.Yii::app()->baseUrl.'/images/facebook_share_icon.gif) no-repeat top right; text-decoration:none; } </style> 
                                                                                    <a rel="nofollow" href="https://www.facebook.com/sharer.php?u=http://'.$_SERVER["SERVER_NAME"].'/wedialog/TypeTags/viewrule?tag_id='.$tag_id.'" class="fb_share_button" onclick="return fbs_click()" target="_blank" style="text-decoration:none;padding:0px 10px 0px 35px;"></a> 
																					<a class="twitter popup" href="http://twitter.com/share"><img src="'.Yii::app()->baseurl.'/images/twitter_icon.png"/></a>
                                                                                </div>
                                                                               <div style="float:left;width: 30%;">
                ...
                $data_str .= '</td>
                                            <td style="vertical-align: top;">
                                                <table style="width:100%">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <span style="text-align: justify;color: #666666;font-family: Arial,Helvetica,sans-serif;  ">'.strip_tags(nl2br($allrule->comment),'<br></br><br/><a>').'</span>
                                                        </td>
                                                    </tr>
    											   <tr id="already_voted_message_'.$allrule->id.'" style="background-color: #FFFA9D;display:none;border:1px solid #666666;width:128px"><td style="color:#666666; text-align: center;" colspan="2">You already voted!</td></tr>
    	                                            <tr style=" width:558px; padding-left:25px;">
                                                                    ...
                                                                    <tr style="float:right;width:100%;">
                                                                        <td style="width:100%">
                                                                            <div>
                                                                                ...
                                                                                <div style="float:left;width: 20%;">
                                                                                    <script>function fbs_click() {u=location.href;t=document.title;window.open("https://www.facebook.com/sharer.php?u=+encodeURIComponent(u)+&t=+encodeURIComponent(t)",sharer,toolbar=0,status=0,width=626,height=436);return false;}</script>
																					<style> html .fb_share_button { display: -moz-inline-block; display:inline-block; padding:1px 20px 0 35px; height:15px;  background:url('.Yii::app()->baseUrl.'/images/facebook_share_icon.gif) no-repeat top right; } html .fb_share_button:hover { color:#fff; border-color:#295582; background:url('.Yii::app()->baseUrl.'/images/facebook_share_icon.gif) no-repeat top right; text-decoration:none; } </style> 
                                                                                    <a rel="nofollow" href="https://www.facebook.com/sharer.php?u=http://'.$_SERVER["SERVER_NAME"].'/wedialog/TypeTags/viewrule?tag_id='.$tag_id.'" class="fb_share_button" onclick="return fbs_click()" target="_blank" style="text-decoration:none;padding:0px 10px 0px 35px;"></a> 
																					<a class="twitter popup" href="http://twitter.com/share"><img src="'.Yii::app()->baseurl.'/images/twitter_icon.png"/></a>
                                                                                </div>
                                                                               <div style="float:left;width: 30%;">
    ...
    public function actionUpdatetypetags($tag_id=''){
        ...
        {
            $rule_model = TypeTags::model()->find(array('condition'=>'id='.$tag_id));
        }
        else
        {
    ...
    public function actionOrder(){
        ...
        $this->data['Tagtypemodel'] = $Tagtypemodel;
         ...
         if(isset($_POST['TypeTags'])){
            $status=TypeTags::model()->updateAll(array('order_no'=>'0'), 'dialog_id='.$dialogID);
            $i=1;

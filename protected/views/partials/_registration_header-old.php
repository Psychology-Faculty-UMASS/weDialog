<div class="header">
    <div class="header_main">
        ...
        <div class="logo" style="width:812px; height:90px; text-overflow:clip; background-image: url('https://wedialog.net/images/logo.png');
    background-repeat: no-repeat; background-color: transparent; margin-bottom: 10px;">

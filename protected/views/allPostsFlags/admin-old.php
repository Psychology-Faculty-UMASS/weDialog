        ...
        array(
            ...
            array(
                ...
                'value'=>function($data){
                        if($data->post_type == 1)
                        {
                             return CHtml::link($data->flag_to_post_relation->comment,Yii::app()->createUrl("Topics/viewtopic",array("topic_id"=>$data->flag_to_post_relation->main_id )), array("target"=>"_blank","style"=>"color: #065A95;font-size: 14px; font-weight: bold; text-decoration: none;"));
                        }
                        else if($data->post_type == 2)
                        {
                             return CHtml::link($data->flag_to_post_relation->comment,Yii::app()->createUrl("TypeTags/viewrule",array("tag_id"=>$data->flag_to_post_relation->main_id )), array("target"=>"_blank","style"=>"color: #065A95;font-size: 14px; font-weight: bold; text-decoration: none;"));
                        }
                        else if($data->post_type == 3)
                        {
                             return CHtml::link($data->flag_to_post_relation->comment,Yii::app()->createUrl("team/viewteam",array("id"=>$data->flag_to_post_relation->main_id )), array("target"=>"_blank","style"=>"color: #065A95;font-size: 14px; font-weight: bold; text-decoration: none;"));
                        }
                 }, 
            	//'filter' =>array('1'=>'YES','0'=>'NO'),
            ),            

...
<div class="admin_login_form_titel" style="width:98%">
    <table width="100%">
        <tr>
            <td>Manage Comment of Team <?php //echo $model->topic_id;?></td>
            <td></td>
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
    ...
    'columns'=>array(
        ...
        array(
            //'header'=>'Green Count',
            'name'=>'green_flag',
            'value'=>'count($data->team_green_comment)',
            'filter'=>'',
            'sortable'=>true,
        ...
        array(
            'name'=>'red_flag',
            'value'=>'count($data->team_red_comment)',
            'filter'=>'',
            'sortable'=>true,
            'htmlOptions'=>array('style'=>'width: 12%;text-align:center;'),
        ),
...
<form name="checked_items" method="POST" action="<?php echo Yii::app()->createUrl('TeamComment/managecomment'); ?>">

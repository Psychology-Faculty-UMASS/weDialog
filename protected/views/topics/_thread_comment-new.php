                ...
                $data_str .= '</td>
                                            <td style="vertical-align: top;">
                                                <table style="width:100%">
                                                    <tr>
                                                        <td>
                                                            <span style="color:#3C1B85;font-family: Arial,Helvetica,sans-serif; font-size: 14px;" >
                                                                <a href="'.Yii::app()->createUrl('site/DisplayPeople',array('people_id'=>$alltopic->user_comment->id)).'" style="color: #3C1B85;font-size: 14px; font-weight: bold; text-decoration: none;">'.ucfirst($alltopic->user_comment->username).'</a>';
                                                                if($alltopic->comment_id != 0){
                                                                    $data_str .= '<span style="color:#3C1B85;"> > @ </span><a href="'.Yii::app()->createUrl('site/DisplayPeople',array('people_id'=>$alltopic->user_other_comment->user_comment->id)).'" style="color: #3C1B85;font-size: 14px; text-decoration: none;">'.ucfirst($alltopic->user_other_comment->user_comment->username).'</a>';
                                                                }
                                                                    $data_str .= '<span style="font-size: 14px;'.$color.'"> - '.date('m-d-Y',$stringtime).' at '.date('H:i',$stringtime).'</span>
                                                            </span>                                                    
                                                        </td>
                                                    </tr>
                                                    <tr>
    											   ...
    											   <tr id="already_voted_message_'.$alltopic->id.'" style="background-color: #FFFA9D;display:none;border:1px solid #000000;width:128px"><td style="color:#666666;font-size: 14px;text-align: center;" colspan="2">You already voted!</td></tr>
                                                                ...
                                                                <td style="width:100%">
                                                                    <div>
                                                                        <div style="float:left;width: 20%;">
                                                                            ...
                                                                            <span id="likecount_'.$alltopic->id.'" style="color: #999999;font-family: Arial,Helvetica,sans-serif; font-size: 12px;">'.$alltopic->like.'</span>&nbsp&nbsp&nbsp&nbsp;
                                                                            ...
                                                                            <span id="dislikecount_'.$alltopic->id.'" style="color: #999999;font-family: Arial,Helvetica,sans-serif; font-size: 12px;">'.$alltopic->dislike.'</span>
                                                                       	</div>
                                                                       <div style="float:left;width: 60%;">
                                                                            <div class="postareply" id="showtbldetail1_'.$alltopic->id.'_'.$cnt.'" style="color: #999999;font-family: Arial,Helvetica,sans-serif; font-size: 13px;float:left;margin-top:-1px;margin-left:27px;width: 20%;" >
                                                                            ...
                                                                            <div style="float:right;width: 60%;">
                                                                                ...
                                                                                <div id="flag_'.$alltopic->id.'" style="cursor: pointer;;float:right;color:#075A99;width: 50%;font-size: 15px;" onclick="showhide('.$alltopic->id.');">Report</div>

  ...
  <div class="main">
    ...
    <!-- =======================START:COMMAN TABLE================================================-->
      ...
      <div class="topic1" id="<?php echo $TopicList->id;?>" <?php echo $style; ?>>
        ...
        <img src="<?php echo Yii::app()->baseUrl ?>/images/comment-icon.png" id="comment-icon" style="position:relative; top:6px;"/>
		...
		<div id="right_typetag_detail">
        	...
        	<div class="cat1">
                ...
                ?>&nbsp;&nbsp;&nbsp;<a style="cursor: pointer;" id="typetagmore">More</a>
          		...
          		<div class="tagtext">
            		<a href="<?php echo Yii::app()->createUrl('site/DisplayPeople',array('people_id'=>$typetagdetailmodel->typeTags_username->id))?>"><?php echo ucfirst($typetagdetailmodel->typeTags_username->username);?></a>, <a><?php echo date('m-d-Y',strtotime($typetagdetailmodel->created_date));?></a>
            	</div>
        	</div>
		</div>
      	<?php } ?>

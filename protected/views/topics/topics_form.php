...
//jQuery(function($) {
//CKEDITOR.replace('Topics[topic_description]',
//{
//});
//});
...
<div class="main">
    ...
    <div class="main_mid3" style="margin-top:10px;">
      ...
      <div class="topics"> <div class="topic_head"><?php echo $TopicModel->isNewRecord ? 'Create New topic' : 'Update topic';?></div></div>
        ...
        <table border="0" cellpadding="4" cellspacing="0" width="100%" id="show_tbl_detail" class="topic_detail">
          ...
          <tbody>
            ...
            <td align="right" width="21%" class="title_font_size">*Topic Title  :</td>
            ...
            <td width="79%">
                ...
                <?php
                    ...
                    if(Yii::app()->session['topic_title']){
                        ...
                        $value=Yii::app()->session['topic_title'];

                    }

                    echo $form->textField($TopicModel,'topic_title',array("class"=>"tag1","value"=>$value,"maxlength"=>"124"));

                ?>

                <?php echo $form->error($TopicModel,'topic_title',array("class"=>"uservalidate"));?>
          ...
          <tr>
            ...
            <td align="right" valign="top" class="title_font_size">Topic Description :</td>

            <td>

            <?php

                if(Yii::app()->session['topic_discription1']){

                    
                    if($this->action->id!="updatetopic")
                    {
                        $value_description = Yii::app()->session['topic_discription1'];
                    }
                    else{
                        $value_description = $TopicModel->topic_description;
                    }
            ...
            <?php echo $form->textArea($TopicModel,'topic_description',array("value"=>$value_description, "style"=>"width:99%; height:200px; font-size: 15px; line-height:130%; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif"));?>
            <?php echo $form->error($TopicModel,'topic_description',array("class"=>"uservalidate"));?>
           ...
           <tr>
            ...
            <td width="79%">
            <select class="populate select2-offscreen tag1" style="width:300px" id="Topics_category_tags" name="Topics[category_tags][]" multiple="" tabindex="-1">
			<?php 
          ...
          <tr>
            ...
            <td align="right" width="21%" class="title_font_size"><span>Pin to top  :</span></td>

            <td width="79%">

                <?php

                    if(Yii::app()->session['pin_to_top']){

                        $value=Yii::app()->session['pin_to_top'];

                    }

                    echo $form->checkBox($TopicModel,'pin_to_top',array("maxlength"=>"1", "style"=>"width:14px"));

                ?>

                <?php echo $form->error($TopicModel,'pin_to_top',array("class"=>"uservalidate"));?>

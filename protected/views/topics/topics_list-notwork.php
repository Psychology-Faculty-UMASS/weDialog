  ...
  <div class="main">
      ...
      <div class="topics">
       ...
       <div class="menu1">
           <?php $agreeMenuDisplay = (isset(Yii::app()->session['dialog_id']) && TopicQuestions::model()->count('dialog_id=:did AND question1<>""', array(':did'=>$dialogID))>=1)?"inline":"none"; ?>
            <a id="agree" style="padding: 0 0 0 3px;vertical-align: top; text-decoration: none;cursor: pointer;color:  #c3c3c3; display: <?php echo $agreeMenuDisplay; ?>" >Agree &nbsp;|&nbsp;</a> 
            <a id="popular" style="padding: 0 0 0 3px;vertical-align: top; text-decoration: none;cursor: pointer;color:  #c3c3c3<?php //echo (isset(Yii::app()->session['dialog_id']) && TopicQuestions::model()->count('dialog_id=:did AND question1<>""', array(':did'=>$dialogID))>=1)?"#c3c3c3":"#000000" ?>;" >Active &nbsp;|&nbsp;</a> 
            <a id="date" style="padding: 0 0 0 3px;vertical-align: top; text-decoration: none;cursor: pointer;color: #c3c3c3;" >New &nbsp;|&nbsp;</a>
            <a id="last_post" style="padding: 0 0 0 3px;vertical-align: top; text-decoration: none;cursor: pointer;color: #000000;" >Last Post</a>
            <a id="mytopics" style="display:none; padding: 0 0 0 3px;vertical-align: top; text-decoration: none;cursor: pointer;color: #c3c3c3;" >My</a>  
    ...
    <!-- =======================START:COMMAN TABLE================================================-->
      ...
      <div class="topic1" id="<?php echo $TopicList->id;?>" <?php echo $style; ?>>
        <h2 style="size: auto;text-decoration-color:#3C1B85 ;">
            <a href="<?php echo Yii::app()->createUrl('topics/Viewtopic',array('topic_id'=>$TopicList->id))?>" style="text-decoration: none;color: #3C1B85;">
        ...
        <img src="<?php echo Yii::app()->baseUrl ?>/images/comment-icon.png" style="position:relative; width:25px; top:6px;"/>
     ...
     <?php }?>            
      ...
      <div class="topic1" id="<?php echo $TopicListBymytopics->id;?>" <?php echo $style; ?>>
        <h2 style="size: auto;text-decoration-color:#3C1B85 ;">
            <a href="<?php echo Yii::app()->createUrl('topics/Viewtopic',array('topic_id'=>$TopicListBymytopics->id))?>" style="text-decoration: none;color: #3C1B85;">
                <img src="<?php echo Yii::app()->baseUrl;?>/images/Square.png"/>
      ...
      <div class="topic1" id="<?php echo $TopicListBypopular->id;?>" <?php echo $style; ?>>
        <h2 style="size: auto;text-decoration-color:#3C1B85 ;">
            <a href="<?php echo Yii::app()->createUrl('topics/Viewtopic',array('topic_id'=>$TopicListBypopular->id))?>" style="text-decoration: none;color: #3C1B85;">
             <img src="<?php echo Yii::app()->baseUrl;?>/images/Square.png"/>
      ...
      <div class="topic1" id="<?php echo $TopicListByagree->id;?>" <?php echo $style; ?>>
        <h2 style="size: auto;text-decoration-color:#3C1B85 ;">
            <a href="<?php echo Yii::app()->createUrl('topics/Viewtopic',array('topic_id'=>$TopicListByagree->id))?>" style="text-decoration: none;color: #3C1B85;">
             <img src="<?php echo Yii::app()->baseUrl;?>/images/Square.png"/>
      ...
      <div class="topic1" id="<?php echo $TopicListBydateModel->id;?>" <?php echo $style; ?>>
        <h2 style="size: auto;text-decoration-color:#3C1B85 ;">
            <a href="<?php echo Yii::app()->createUrl('topics/Viewtopic',array('topic_id'=>$TopicListBydateModel->id))?>" style="text-decoration: none;color: #3C1B85;">
            <img src="<?php echo Yii::app()->baseUrl;?>/images/Square.png"/>
      ...
      <div class="topic1" id="<?php echo $TopicListBylastpostModel->id;?>" <?php echo $style; ?>>
        <h2 style="size: auto;text-decoration-color:#3C1B85 ;">
            <a href="<?php echo Yii::app()->createUrl('topics/Viewtopic',array('topic_id'=>$TopicListBylastpostModel->id))?>" style="text-decoration: none;color: #3C1B85;">
            <img src="<?php echo Yii::app()->baseUrl;?>/images/Square.png" style="width:15px"/>
            ...
            <tr>
                <td>
                    <table class="content_box form_lable" style="width:100%; vertical-align: top;">
                        ...
                        <tr>
                        	<td height="30" style="vertical-align: top; color: #3C1B85;font-weight: normal; "><?php echo ucwords($tagdetailmodel->cat_tag);?>
        ...
        <table style="width:99%; vertical-align: top;display: none;margin: 8px 10px;" id="toggle_typetag_column" >
            ...
            <tr>
                <td>
                    <table class="content_box form_lable" style="width:100%; vertical-align: top;">
                        <tr>
                        	<td height="30" style="vertical-align: top; color: #3C1B85;font-weight: normal; "><?php echo ucwords($typetagdetailmodel->type_tag);?>

        ...
        <table width="100%">
            <tr>
                ...
                <td style="float: right;">
                    ...
                    <span>
                        <a href="<?php echo Yii::app()->createUrl('users/create'); ?>" style="text-decoration: none"  title="Create new record">
                    ...
                    <span>
                        <a href="javascript:void(0)" style="text-decoration: none" onclick="javascript:block_Users();" title="Block selected users">
                            <img src="<?php echo Yii::app()->request->baseUrl;?>/images/block.png" width="24" height="24" />
                        </a>
                    </span>
                   
   
                     <span>
                        <a href="javascript:void(0)" style="text-decoration: none" onclick="javascript:active_admins();" title="Make selected users Admin">
                    ...
                    if($this->data["group_id"]=="1"){ ?>                  
                    <span>
                        <a href="javascript:void(0)" style="text-decoration: none" onclick="javascript:inactive_admins();" title="Remove selected users from Admin">
...
/*                    array(
                    ...
                    array(
                        'name'=>'group_id',
                        'value'=>'myhelpers::getGroup($data->group_id)',
                        'filter' => Yii::app()->params['viewGroup'],
                    ),
                    /*
                    'user_description',
                    'facebook_link',

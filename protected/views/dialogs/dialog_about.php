...
<div class="main">
    <div class="main_mid3" style="width: 90%;">
      <div class="topics"> <div class="topic_head">
        <?php
        if($action == "create"){
            $title = 'Create Dialog about';   
        }else {
            $title = 'Edit Dialog about';
        }
        echo $title;
        ?>      
      </div></div>
        ...
        <table border="0" cellpadding="4" cellspacing="0" width="100%" id="show_tbl_detail" class="topic_detail">
          <tbody>
            ...
            <td width="79%">
                <?php
                    echo $form->textField($model,'dialog_about_title',array("class"=>"tag1","maxlength"=>"124"));
                    echo $form->error($model,'dialog_about_title',array("style"=>"color:red"));
                ?>
            </td>
          </tr>
          	<tr>
            ...
            <td width="79%">
                <?php
                    echo $form->textArea($model,'dialog_about_description');
                    echo $form->error($model,'dialog_about_description',array("style"=>"color:red;height:350px;"));
                ?>
            </td>
          </tr>
          <tr>
            ...
            <td>
                ...
                <?php
                    $redirect_url = Yii::app()->createUrl('dialogs/DialogList');
                ?>

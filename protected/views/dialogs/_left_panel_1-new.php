...
<div class="left_main_menu">
	<ul>
		...
		<li class="lg-only"><a <?php echo $people_class;?> href="<?php echo Yii::app()->createUrl('site/PeopleList', array("dialog_id"=>$dialogID))?>">PEOPLE</a></li>
        <li class="lg-only"><a <?php echo $about_class;?> href="<?php echo Yii::app()->createUrl('dialogs/about', array("dialog_id"=>$dialogID))?>">ABOUT</a></li>

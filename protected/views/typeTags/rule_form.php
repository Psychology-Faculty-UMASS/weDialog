      ...
      <div class="topics"> <div class="topic_head"><?php if($rule_model->id){?> Edit <?php }else{?> PROPOSE NEW <?php }?> Rule</div></div>
        ...
        <table border="0" cellpadding="4" cellspacing="0" width="100%" id="show_tbl_detail" class="topic_detail">
          ...
          <tr>
            ...
            <td>
                <?php echo $form->textArea($rule_model,'type_tag_description',array("style"=>"width:99%; height:200px; font-size: 15px; line-height:130%; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif"));?>
                <?php echo $form->error($rule_model,'type_tag_description',array("class"=>"uservalidate"));?>
                <!--<textarea name="TypeTags[type_tag_description]" id="" aria-hidden="true"></textarea>-->
            </td>
          </tr>
          <tr>
            <td height="5" colspan="2" align="left"><img src="<?php echo Yii::app()->request->baseUrl;?>/images/spacer.gif" width="1" height="1" /></td>
            </tr>
...
//jQuery(function($) {
//CKEDITOR.replace('TypeTags[type_tag_description]',
//{
//});
//});
</script>
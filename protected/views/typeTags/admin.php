...
<div class="admin_login_form_titel" style="width:98%">
	<table width="100%">
		<tr>
			...
			<span>
				<a href="<?php echo Yii::app()->createUrl('typeTags/create'); ?>" style="text-decoration: none"  title="New create record">
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
		...
		array(
				'name' => 'user_id',
				'value'=>'$data->typeTags_username->username',
		...
		array(
            ...
            /* 'buttons'=>array(                
               'viewcoments'=>array(
					...
					'url'=>'Yii::app()->createUrl("TypeTagsComment/managetopiccomment", array("id" => $data->id))',
                    'label'=>'View Coments',
    			),        
    		), */
		),
...
<form name="checked_items" method="POST" action="<?php echo Yii::app()->createUrl('typeTags/Manage_typetags'); ?>">

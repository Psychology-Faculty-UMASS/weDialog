            ...
            <td>
                <table style="width:99%; vertical-align: top;">
                    <tr>
                        <td> 
						<?php
						    $form = $this->beginWidget('CActiveForm', array('id'=>'tag-type-comment-form',
						...
						?>
							<table style="width:100%; vertical-align: top; display:none" id="showmessage">
								<tr>
									<td>
										<textarea id="post_comment_area" name="post_comment_area" style="width:100%; height:250px;"></textarea>
									</td>
								</tr>

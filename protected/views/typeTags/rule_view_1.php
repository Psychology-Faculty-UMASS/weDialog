    ...
    <div class="main_mid">
        ...
        <div class="topic1" id="show_tbl_detail" style="padding: 0 10px;">
            <div style="padding-bottom:13px;float:left;">
                <?php if($rule_model->user_id == Yii::app()->session['user_id'] || Yii::app()->session['group_id']==1){ ?>
            ...
            <div>
                ...
                <p class="rule_desc_text" style="font-family: tahoma; width:100%; word-wrap: break-word;">
                    <?php if(!empty($rule_model->type_tag_description)){
                        ...
                        echo "<span style='font-size:14px; font-family:Arial;' class='rule-desc-less-text'>".$ruleDesc."</span>";

<div class="category" id="rightboxtoggle5" style="border-bottom:none;">
    ...
    <div class="categoryr_head" onclick="javascript: topicdetailmore2('<?php echo $team_model->id; ?>')" style="cursor: pointer;font-family: Arial;font-size: 14px;">About Group</div>
...
<div style="float:left;width:98%;text-align:center;">
	<input class="topic" style="cursor:pointer; text-align:center; background: none repeat scroll 0 0 #3C1B85; height:25px; border-radius: 0px;"  onclick="confirmmember('<?php echo ucwords($team_model->name);?>');" value="JOIN" />
	<br />

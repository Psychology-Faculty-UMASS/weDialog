      ...
      <div class="topics"> <div class="topic_head"><?php if($team_model->id){?> Update <?php }else{?> Create New <?php }?> Team</div></div>
        ...
        <table border="0" cellpadding="4" cellspacing="0" width="100%" id="show_tbl_detail" class="topic_detail">
          ...
          <tr>
            ...
            <td>
                <?php echo $form->textArea($team_model,'description',array("style"=>"width:99%; height:200px; font-size: 15px; line-height:130%; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif"));?>


                <?php echo $form->error($team_model,'description',array("class"=>"uservalidate"));?>
                
<!--<textarea name="Team[description]" id="" aria-hidden="true"></textarea>-->
...
//jQuery(function($) {
//CKEDITOR.replace('Team[description]',
//{
//});
//});
</script>
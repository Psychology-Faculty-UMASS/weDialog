            ...
            <table width="100%" style="vertical-align: top;padding: 0px;" cellspacing="0" cellpadding="0" border="0">
                <tr style="vertical-align: top;">
                    <td style=" float:left;font-size:18px;font-weight: bold;">
                       ...
                       <a href="<?php echo Yii::app()->createUrl('site/Viewpeople',array('people_id'=>$PeopleList->id))?>" style="text-decoration: none; font-weight: normal; color: #065A95 !important;font-size: 17.5px;">
                ...
                <tr>
                    <td>
                        <table width="40%" >
                            <tr>
                                <td style="font-size: 13px;color: #999999;">Posts(<?php echo $PeopleList['Totalpostscount']; //count($PeopleList->user_all_post_relation); ?>)</td>

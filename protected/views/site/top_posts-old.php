...
$(document).ready(function(){
    ...
    <?php }?>
    $("#topmessage,#greenflagmessage,#redflagmessage").click(function() {
        var ID = $(this).attr("id");
        //alert('1')
        //$("#my_detail").hide();
        //$("#date_detail").hide();
                ...
                <table style="width:98%;">
                    <tr style="font-family:Verdana;width:30px; margin:0px 0 0 0; ">
                        <td style="float:left;font-family:Verdana" >
                            ...
                            <a style="font-family:Verdana;font-size: small;cursor: pointer;text-decoration: none;color:#000000;" id="topmessage" onclick="javascript:change_current_section('popular_topics');">AGREE &nbsp;|&nbsp;</a> 
...
<?php if(Yii::app()->session['group_id']==1 || Yii::app()->session['group_id']==3){ ?>
                            ...
                            <a style="font-family:Verdana;font-size: small;cursor: pointer;text-decoration: none;color:#c3c3c3;" id="hiddenflagmessage" onclick="javascript:change_current_section('hidden');">HIDDEN </a>

                ...
                <tr>                    
                    <td style="width:85px; vertical-align: top;">
                        <a href="">
                           ...
                           <a href="" style="text-decoration: none;color: #065A95 !important;font-size: 21px;">
                ...
                <table style="width:98%;">
                    <tr style="font-family:Verdana;width:30px; margin:0px 0 0 0; ">
                        <td style="float:left;font-family:Verdana" >
                            <!--<a style="font-family:Verdana;pointer;text-decoration: none;color:#000000;" href="javascript:void(0);" id="allmessage" onclick="threadcomment('');">THREAD &nbsp;|&nbsp;</a>-->                            
...
<script>
    ...
    function setFlagMessage(comment_id,main_id,post_type,flag_type){
        ...
        if(flag_type == 'Green'){
            ...
            $('#red_open_form').html('');
            $('body').css('background-color','#A6A6A6');
            $('body *').not('#red_open_form').css/*({opacity:'0.0'})*/;
...
<div id="red_open_form" style="display: none; width: 35%; position: fixed; opacity: 0.0; z-index: 11000; left: 50%; margin-left: -249px; top: 200px;">
        <?php
            $form = $this->beginWidget('CActiveForm', array(
            		'id'=>'topic-form',

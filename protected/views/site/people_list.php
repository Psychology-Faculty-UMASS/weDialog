...
$(document).ready(function(){
    ...
    $("#toppeople,#blockpeople,#agreepeople,#newestpeople,#allpeople,#greenflagpeople,#redflagpeople").click(function() {
        var ID = $(this).attr("id");
       ...
       if(ID=='toppeople'){
            ...
            document.getElementById('blockpeople').style.color = '#c3c3c3';
        ...
        }else if(ID=='blockpeople'){ 
            currect_section = "blockpeople";
            $('#blockpeople').css({ 'color':'#000000' });
...
<div class="main">
    ...
    <div class="main_mid">
       ...
       <div class="menu1" style="padding-bottom: 16px;" >
            <a style="padding: 0; vertical-align: top; text-decoration: none;cursor: pointer;color: #000000;" id="toppeople" >POSTS &nbsp;|&nbsp;</a>
			<a style="padding: 0 0 0 3px;vertical-align: top; text-decoration: none;cursor: pointer;color:#c3c3c3;" id="greenflagpeople"> GREEN FLAG &nbsp;|&nbsp;</a>
		    <a style="padding: 0; vertical-align: top; text-decoration: none;cursor: pointer;color: #c3c3c3; display:'<?php echo (!$dialogHasQuestions)?"none":""; ?>'" id="agreepeople" >AGREE &nbsp;|&nbsp;</a>
			<a style="padding: 0 0 0 3px;vertical-align: top; text-decoration: none;cursor: pointer;color:#c3c3c3;" id="newestpeople">NEW &nbsp;|&nbsp;</a>
<?php if(Yii::app()->session['group_id']==1 || Yii::app()->session['group_id']==3){ ?>          
			<a style="padding: 0 0 0 3px;vertical-align: top; none;cursor: pointer;color:#c3c3c3;" id="redflagpeople">RED FLAG &nbsp;|&nbsp;</a>
            <a style="padding: 0; vertical-align: top; text-decoration: none;cursor: pointer;color: #c3c3c3; " id="blockpeople" >BLOCKED</a>
<?php } ?>
     ...
     <!-- ============================END:COMMON=============================-->
        <!-- ============================START:COMMON=============================-->
        <table class="content_box form_lable" style="width:98%;display: none;" id="block_people_list" >
            <?php
            $blockpeople_last_id = 0;
            
            foreach($BlockPeopleListModel AS $PeopleList){$i++;
            ?>
            <tr id="<?php echo $PeopleList->id;?>" class="tr_people_data">
                <td style="width:100%">
                    <?php $this->renderPartial('/site/_block_people_list',array('PeopleList'=>$PeopleList));?>
                </td>                    
            </tr>
            
            <?php
            $blockpeople_last_id = $PeopleList->id;
            }
            ?>
        </table>
     <!-- ============================END:COMMON=============================-->
...
var blockpeople_last_id = <?php echo $blockpeople_last_id;?>;
...
$(function(){
    var scrollFunction = function(){
        ...
        if ($(window).scrollTop() > mostOfTheWayDown) {
            ...
            }else if(currect_section == "blockpeople" && blockpeople_ajax_msg==""){
            	data_str = "currect_section=blockpeople&next_page="+blockpeople_next_page+"&last_id="+blockpeople_last_id;
            	currect_section_div_id = "block_people_list";
	            ...
	            $.ajax({
	                ...
	                success: function(people_data){
	                   //alert(people_data);
	    	            ...
	    	            }else if(currect_section == "blockpeople"){
	    	            	blockpeople_next_page++;
	    	            	blockpeople_last_id = last_id;
							//$("#"+currect_section_div_id).append(people_result[2]);

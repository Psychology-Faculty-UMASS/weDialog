                ...
                <tr>                    
                    <td style="width:85px; vertical-align: top;">
                        <a href="">
                           ...
                           <a href="<?php echo Yii::app()->createUrl('Site/viewpeople',array('people_id'=>$user_model->id))?>" style="text-decoration: none;color: #065A95 !important;font-size: 17.5px;">
                                <?php echo ucfirst($user_model->username);?>
                            </a>
                        <?php if(Yii::app()->session['group_id']==1 || Yii::app()->session['group_id']==3){?>
                        <?php if($user_model->status!='Block') { ?>
                        <span style="float: right;"><input name="" onchange="block_user(<?=$user_model->id;?>)" id="" value="1" type="checkbox"> Block User</span>
                        <?php }else{ ?>
                        <span style="float: right;"><input name="" onchange="unblock_user(<?=$user_model->id;?>)" id="" value="1" type="checkbox" checked="">Unblock User</span>
                        <?php } ?>
                        <?php } ?>
                    </td>
                ...
                <table style="width:98%;">
                    <tr style="font-family:Verdana;width:30px; margin:0px 0 0 0; ">
                        <td style="float:left;font-family:Verdana" >
                            ...
                            <a class="active" style="font-family:Verdana;  cursor: pointer;text-decoration: none;color:#000000;" id="datemessage" onclick="javascript:change_current_section('date_topics');">NEW &nbsp;|&nbsp;</a> 
                            ...
                            <!--<a style="font-family:Verdana; cursor: pointer;text-decoration: none;color:#c3c3c3;" id="mymessage" onclick="javascript:change_current_section('my_topics');">MY</a>-->
                        </td>
...
function get_topic_comments(temp_var){
	...
	if(need_ajax_call==1){
		...
		if(ajax_call_complated==1 || is_fist_call == 1){
			is_fist_call = 0;
			$.ajax({
			url: "Getcomments?user_id="+'<?php echo $people_id;?>'+"&selected_user_id="+selected_user_id,
			data: data_str,
			type: 'POST',
			dataType: "json",
			async:false,
